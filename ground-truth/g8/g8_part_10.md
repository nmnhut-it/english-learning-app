...
**Mark:** Chờ chút. Đó là câu lạc bộ công nghệ ở trường Nhật Bản phải không? 

**Trang:** Chính xác. Nhưng tôi thì hơi lo lắng. Tôi chưa bao giờ có một cuộc họp video trước đây.

**Mark:** Bạn đang đùa à\! Ai không biết cách làm cuộc gọi video? Được rồi, chúng ta hãy làm một cuộc gọi tập thử bây giờ. 

**Trang:** Hmm, tôi cần phải làm gì trước?

**Mark:** Chuyện đó thì dễ, trang. Bây giờ, bạn ngồi trước máy tính. Tôi sẽ kết nối bạn với một trong những máy tính của tôi và … 

**Trang:** Xin lỗi, nhưng tôi có thể chỉnh webcam này bằng cách nào? Nó đang tập trung vào trán của tôi. 

**Mark:** Sử dụng nút này để di chuyển nó lên hoặc xuống, và cái này để phóng to hoặc thu nhỏ. 

**Trang:** Cảm ơn. Và bạn có thể thấy tôi rõ trong máy tính bản của bạn không? 

**Mark:** Vâng, dĩ nhiên. Chúng ta có một kết nối Internet tốc độ cao ở đây. 

**Trang:** Tôi hi vọng cuộc họp diễn ra suôn sẻ.  

**Mark:** Tôi chắc chắn nó sẽ. Chúng ta nên tổ chức nhiều cuộc họp video hơn như thế này trong tương lai 

**Trang:** Đó đúng là cách mà tôi cảm thấy.    
...
I will be back in two days: Tôi sẽ trở lại trong vòng hai ngày 

for \+ khoảng thời gian: tính tới …. thì được 

I have studied English for two years: Tôi đã học tiếng Anh tính tới nay được hai năm

by \+ mốc thời gian: trước/tính tới  thì … đã xong
...
Tôi nghĩ điện thoại thông minh sẽ thay đổi rất nhiều trong tương lai gần. Chúng sẽ mỏng hơn rất nhiều. Vào năm 2035, chúng ta có thể cuộn điện thoại như một tờ giấy. Chúng cũng sẽ trở nên thông minh hơn nhiều. Chúng sẽ có thể tự động sạc pin khi chúng ta ở nhà. Chúng có thể kiểm tra tin tức mới nhất trên mạng Internet. Chúng ta sẽ không phải chờ đợi lâu để có những chiếc điện thoại thông minh siêu việt này.

**Bài 5 trang 108** 

**Đại từ sở hữu**

Không đứng trước danh từ, dùng 

như 1 danh từ độc lập 
...
Trang: Xin lỗi vì ngắt lời, nhưng tôi nghĩ chúng ta nên gặp lúc 9:00 sáng. Chúng ta cần kiểm tra các thiết bị.

Nick: Webcam này rất dễ sử dụng. Bạn nhấp các nút này để di chuyển nó lên xuống và những nút này để...
...
4. Emoji help people communicate their emotions effectively regardless of the language they speak.   
5. Because Emoji help people communicate their emotions effectively regardless of the language they speak. They can replace words …. everywhere. 
...
MC: Chào tất cả mọi người. Hôm nay, tôi sẽ mời một số thành viên của Câu lạc bộ Công nghệ dự đoán cách mọi người sẽ giao tiếp trong tương lai. Hãy gặp Minh và Tom.

Minh & Tom: Chào tất cả mọi người.

MC: Minh và Tom, các em và bạn bè giữ liên lạc với nhau như thế nào?

Minh: À, chúng em chủ yếu nhắn tin cho nhau. Chúng em cũng gửi tin nhắn thoại.

Tom: Em thường gặp bạn bè trực tiếp, nhưng đôi khi chúng em gọi điện qua Internet.

MC: Các em có nghĩ những cách giao tiếp này vẫn sẽ phổ biến trong 50 năm nữa không?

Tom: Không hẳn. Chúng ta sẽ sử dụng những cách tiên tiến hơn, như thần giao cách cảm. Chúng ta sẽ truyền suy nghĩ cho người khác mà không cần nói và...

MC: Khoan đã, thầy nghĩ chỉ một số ít người có khả năng này thôi.

Minh: Vâng, nhưng trong tương lai, mọi người sẽ có thể sử dụng thần giao cách cảm. Chúng ta sẽ đeo một thiết bị nhỏ để bắt suy nghĩ và gửi cho người khác.

MC: Hay quá\! Nhưng liệu có vấn đề gì với thần giao cách cảm không?

Tom: Hmm, thiết bị thần giao cách cảm có thể "đọc" được tâm trí, nên người xấu có thể lợi dụng để kiểm soát người khác.

MC: Ngoài ra, một số người sẽ trở nên quá lười để nói chuyện nữa.
...
Social networks help people talk to each other. You can use apps like Facebook, Instagram, and Zalo. These apps let you send messages to friends and share photos and videos. You can talk to family who live far away. You can also learn new things happening in the world. Social media lets us talk to people all around the world very quickly with just a few clicks\!
