...
<!-- chunk: comparative_intro -->
<grammar>
### SO SÁNH HƠN (Comparative Adjectives)

**Khi nào dùng?**
So sánh giữa HAI người, vật, hoặc sự việc.
...
<!-- chunk: comparative_short -->
<grammar>
### Tính từ ngắn (1 âm tiết hoặc 2 âm tiết kết thúc -y)

**Công thức:** Tính từ + **-er** + **than**

**Ví dụ:**
- tall → tall**er** than *(cao hơn)*
- fast → fast**er** than *(nhanh hơn)*
...
<!-- chunk: comparative_short_special -->
<grammar>
### Lưu ý đặc biệt với tính từ ngắn

**Kết thúc -y:** đổi **y → i** + er
- happy → happ**ier** than
- easy → eas**ier** than

**Kết thúc 1 phụ âm sau 1 nguyên âm:** nhân đôi phụ âm + er
- big → big**ger** than
- hot → hot**ter** than
- thin → thin**ner** than
</grammar>
...
<!-- chunk: comparative_long -->
<grammar>
### Tính từ dài (2+ âm tiết)

**Công thức:** **more** + tính từ + **than**
...
<!-- chunk: comparative_irregular -->
<grammar>
### Dạng bất quy tắc (phải thuộc lòng)

| Tính từ gốc | So sánh hơn |
|-------------|-------------|
| good | **better** than *(tốt hơn)* |
| bad | **worse** than *(tệ hơn)* |
| far | **farther/further** than *(xa hơn)* |
| many/much | **more** than *(nhiều hơn)* |
...
<!-- chunk: superlative_intro -->
<grammar>
### SO SÁNH NHẤT (Superlative Adjectives)

**Khi nào dùng?**
So sánh MỘT người/vật với CẢ NHÓM (3 người trở lên).

**Thấy "in/of the..." → Dùng so sánh nhất!**
...
<!-- chunk: superlative_short -->
<grammar>
### Tính từ ngắn

**Công thức:** **the** + tính từ + **-est**

**Ví dụ:**
- **the** tall**est** *(cao nhất)*
- **the** fast**est** *(nhanh nhất)*
- **the** cheap**est** *(rẻ nhất)*

**Lưu ý:**
- Kết thúc -y → đổi y → i + est: **the** happ**iest**
...
<!-- chunk: superlative_long -->
<grammar>
### Tính từ dài

**Công thức:** **the most** + tính từ
...
<!-- chunk: superlative_irregular -->
<grammar>
### Dạng bất quy tắc

| Tính từ gốc | So sánh nhất |
|-------------|--------------|
...
**Khi nào dùng?**
So sánh hai người/vật có mức độ BẰNG NHAU hoặc KHÔNG BẰNG NHAU.

**Khẳng định:** **as** + tính từ + **as**
- Tom is **as tall as** John. *(Tom cao bằng John)*

**Phủ định:** **not as** + tính từ + **as**
- Coffee is **not as popular as** tea.
...
<!-- chunk: too -->
<grammar>
### TOO (quá - mang nghĩa phủ định)

**Công thức:** **too** + tính từ + (for sb) + to + động từ
**Nghĩa:** Quá...đến nỗi không thể...

**Ví dụ:**
- This coffee is **too hot**. I can't drink it.
  *(Cà phê quá nóng, tôi không thể uống được)*
...
**Công thức:** tính từ + **enough** + (for sb) + to + động từ
**Nghĩa:** Đủ...để có thể...

**Ví dụ:**
- Are you **tall enough to** reach the shelf?
  *(Bạn có đủ cao để với tới kệ không?)*
- She is **old enough to** go to school.
  *(Cô bé đủ tuổi để đi học)*

**VỊ TRÍ QUAN TRỌNG:**
- **too** + tính từ *(too đứng TRƯỚC)*
...
| Sai | Đúng |
|-----|------|
| She is the taller than me. | She is **taller** than me. |
| more tall | **taller** |
| more good | **better** |
...
Thứ ba, tính từ dài không thêm ER. More beautiful, không phải beautifuler. More expensive, không phải expensiver.

Thứ tư, bất quy tắc phải nhớ. Better, không phải gooder hay more good.

Thứ năm, so sánh nhất phải có THE. The tallest, không phải tallest.

Thứ sáu, nhớ vị trí too và enough. Too big, không phải big too. Big enough, không phải enough big.

Ghi nhớ mấy lỗi này nha!
</teacher_script>
