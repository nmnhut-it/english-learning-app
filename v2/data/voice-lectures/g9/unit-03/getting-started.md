...
Ok lớp 9, vào <eng>Unit 3: Healthy Living for Teens</eng> nha — Sống khỏe cho tuổi teen. Bài này học về sức khỏe thể chất lẫn tinh thần luôn. Mở sách ra, ghi tựa bài, rồi bấm "Bắt đầu" để học từ vựng nha.
</teacher_script>

<vocabulary>
1. **tip** : (n) mẹo, lời khuyên /tɪp/
2. **mental** : (adj) thuộc tinh thần /ˈmentl/
3. **physical** : (adj) thuộc thể chất /ˈfɪzɪkl/
4. **health** : (n) sức khỏe /helθ/
5. **session** : (n) buổi học, buổi tập /ˈseʃn/
6. **maintain** : (v) duy trì /meɪnˈteɪn/
7. **sleep** : (n/v) giấc ngủ / ngủ /sliːp/
8. **diet** : (n) chế độ ăn /ˈdaɪət/
9. **exercise** : (n/v) tập thể dục /ˈeksəsaɪz/
10. **regularly** : (adv) thường xuyên /ˈreɡjʊləli/
11. **well-balanced** : (adj) cân bằng, đủ chất /ˌwel ˈbælənst/
12. **priority** : (n) ưu tiên hàng đầu /praɪˈɒrəti/
13. **counselor** : (n) cố vấn tâm lý /ˈkaʊnsələr/
14. **stress** : (n/v) căng thẳng /stres/
15. **productive** : (adj) hiệu quả, năng suất /prəˈdʌktɪv/
16. **exam** : (n) kỳ thi /ɪɡˈzæm/
17. **suggest** : (v) gợi ý, đề nghị /səˈdʒest/
18. **schedule** : (n) thời khóa biểu, lịch /ˈʃedjuːl/
19. **screen time** : (n) thời gian dùng thiết bị điện tử /skriːn taɪm/
20. **concentrate** : (v) tập trung /ˈkɒnsəntreɪt/
</vocabulary>

<teacher_script pause="0">
Học xong rồi nha! Nhớ "mental" — tinh thần và "physical" — thể chất, hai từ này hay bị nhầm lắm. Ghi từ vựng vô tập đi rồi mình vô hội thoại.
</teacher_script>
