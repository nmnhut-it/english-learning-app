...
2. **respond** : (v) phản hồi /rɪˈspɒnd/
3. **give it a go** : thử làm xem sao /gɪv ɪt ə gəʊ/
4. **contribution** : (n) sự đóng góp /ˌkɒntrɪˈbjuːʃn/
5. **habitat** : (n) môi trường sống /ˈhæbɪtæt/
6. **polar** : (adj) thuộc vùng cực /ˈpəʊlə/
7. **North Pole** : Bắc Cực /nɔːθ pəʊl/
8. **South Pole** : Nam Cực /saʊθ pəʊl/
9. **extremely** : (adv) cực kỳ /ɪkˈstriːmli/
10. **tropical forest** : rừng nhiệt đới /ˈtrɒpɪkl ˈfɒrɪst/
11. **temperate forest** : rừng ôn đới /ˈtempərət ˈfɒrɪst/
12. **boreal forest** : rừng hàn đới /ˈbɔːriəl ˈfɒrɪst/
13. **lung** : (n) phổi /lʌŋ/
14. **oxygen** : (n) oxy /ˈɒksɪdʒən/
15. **penguin** : (n) chim cánh cụt /ˈpeŋɡwɪn/
16. **leopard seal** : (n) hải cẩu báo /ˈlepəd siːl/
17. **bat** : (n) con dơi /bæt/
18. **owl** : (n) con cú /aʊl/
19. **deer** : (n) con hươu /dɪə/
20. **squirrel** : (n) con sóc /ˈskwɪrəl/
21. **fox** : (n) con cáo /fɒks/
22. **lizard** : (n) con thằn lằn /ˈlɪzəd/
23. **adjust** : (v) điều chỉnh /əˈdʒʌst/
24. **climate** : (n) khí hậu /ˈklaɪmət/
25. **microscopic algae** : tảo hiển vi /ˌmaɪkrəˈskɒpɪk ˈældʒiː/
26. **sea grass** : cỏ biển /siː ɡrɑːs/
27. **grassland** : (n) đồng cỏ /ˈɡrɑːslænd/
28. **grazing livestock** : gia súc chăn thả /ˈɡreɪzɪŋ ˈlaɪvstɒk/
29. **giraffe** : (n) hươu cao cổ /dʒɪˈrɑːf/
30. **zebra** : (n) ngựa vằn /ˈzebrə/
</vocabulary>
...
### Bai 1 trang 108 - Listen and read

<task>
**De:** Listen and read the conversations. Pay attention to the highlighted parts.

**Dich de:** Nghe va doc doan hoi thoai. Hay chu y den nhung phan duoc danh dau.
</task>

<audio src="https://img.loigiaihay.com/picture/2024/0516/64.mp3">
...
<grammar>
**Useful expressions for persuading:**
*(Cac mau cau de thuyet phuc)*

1. **Why don't you give it a go?** - Tai sao ban khong thu?
2. **How would you feel about + V-ing?** - Ban cam thay the nao ve viec...?
3. **Your contribution would really help us out.** - Su dong gop cua ban thuc su se giup ich cho chung toi.

**Useful responses:**
*(Cac cach tra loi)*

1. **OK, I'll think about that.** - Duoc roi, toi se suy nghi ve dieu do.
2. **Alright. I'll make a contribution.** - Duoc roi. Toi se dong gop.
</grammar>
...
### Bai 2 trang 108 - Speaking

<task>
**De:** Work in pairs. Make similar conversations with the following situations.

**Dich de:** Lam viec theo cap. Thuc hien cac cuoc hoi thoai tuong tu voi cac tinh huong sau.
</task>

<questions type="speaking">
**1.** You persuade your friend to watch a movie about planet Earth.
*(Ban thuyet phuc ban minh xem mot bo phim ve hanh tinh Trai Dat.)*
...
### Bai 3 trang 108-109 - Reading and Matching

<task>
**De:** Read the short descriptions of various habitats and match them with their features.

**Dich de:** Doc nhung mo ta ngan gon ve cac moi truong song khac nhau va noi chung voi cac dac diem cua chung.
</task>
...
<translation>
**Moi truong song vung cuc** bao gom Bac Cuc va Nam Cuc. Nhung moi truong song nay duoc bao phu trong bang va cuc ky lanh va kho. Dong vat o day bao gom ca nho, gau bac cuc, chim canh cut, hai cau bao, v.v.

**Moi truong song trong rung** bao gom rung nhiet doi, rung on doi va rung phuong bac. Chung duoc coi la la phoi cua Trai dat vi chung tao ra oxy. Chung cung cung cap nha cho doi, cu, huou, soc, cao, than lan, v.v.

**Moi truong song o dai duong** bao gom Thai Binh Duong, Dai Tay Duong, An Do Duong, Nam va Bac Bang Duong. Chung tao ra hon 50% luong oxy cua Trai dat va giup dieu chinh khi hau. Chung cung cap noi song cho cac loai thuc vat nhu co bien, tao cuc nho va ca, v.v.
...
*(1. Vung cuc - a. hai loai chinh va rat quan trong cho viec chan tha gia suc)*
*(2. Rung - b. lon nhat, tao ra oxy va dieu hoa khi hau)*
*(3. Dai duong - c. cuc lanh, kho, phu day bang tuyet)*
...
**Thong tin:** "Polar habitats include the North Pole and the South Pole. These habitats are covered in ice and extremely cold and dry."
*(Moi truong song o vung cuc bao gom Bac Cuc va Nam Cuc. Nhung moi truong song nay duoc bao phu trong bang va cuc ky lanh va kho.)*

**2 - d.** Forests: the lungs of Earth, home to many species
*(Rung: la phoi cua Trai Dat, noi sinh song cua nhieu loai sinh vat)*

**Thong tin:** "Forest habitats ... are considered the Earth's lungs ... They also provide homes to bats, owls, deer, squirrels, foxes, lizards, etc."
*(Moi truong song trong rung... duoc coi la la phoi cua Trai Dat ... Chung cung la noi o cua cac loai doi, cu, huou, soc, cao, than lan, v.v.)*

**3 - b.** Oceans: largest, produce oxygen and adjust the climate
*(Dai duong: lon nhat, tao ra oxy va dieu hoa khi hau)*

**Thong tin:** "Ocean habitats include the Pacific, Atlantic, Indian, Southern, and Arctic Oceans. They produce more than 50 per cent of Earth's oxygen and help adjust the climate."
*(Moi truong song o dai duong bao gom Thai Binh Duong, Dai Tay Duong, An Do Duong, Nam va Bac Bang Duong. Chung tao ra hon 50% luong oxy cua Trai Dat va giup dieu chinh khi hau.)*

**4 - a.** Grasslands: two main types and are crucial for livestock grazing
*(Dong co: hai loai chinh va rat quan trong cho viec chan tha gia suc)*

**Thong tin:** "Grasslands include tropical and temperate ones. They are crucial for grazing livestock."
*(Dong co bao gom dong co nhiet doi va on doi. Chung rat quan trong cho viec chan tha gia suc.)*
</answer>
...
### Bai 4 trang 109 - Speaking

<task>
**De:** Work in pairs. Choose two habitats and compare them.

**Dich de:** Lam viec theo cap. Chon hai moi truong song va so sanh chung.

You can refer to the following:
*(Ban co the tham khao nhu sau)*

- their specific types / examples *(loai / vi du cu the cua chung)*
- their importance *(tam quan trong cua chung)*
- plants / animals living there *(thuc vat / dong vat song o do)*
...
<answer>
**Sample comparison: Oceans vs Forests**

| Features | Oceans | Forests |
|----------|--------|---------|
...
### Bai 5 trang 109 - Speaking

<task>
**De:** Report the results of your comparison to the class.

**Dich de:** Bao cao ket qua so sanh cua ban voi ca lop.

Example: While oceans are water bodies, forests are landform habitats. Both oceans and forests provide oxygen to Earth.
...
*Trong khi dai duong la cac vung nuoc thi rung la moi truong song co dia hinh. Chung co vai tro quan trong trong viec duy tri su song tren Trai Dat - ca hai deu cung cap oxy cho Trai Dat, hap thu khi cac bon va dieu hoa khi hau. Moi cai deu co nhung dac diem va tam quan trong rieng. Moi truong song trong rung bao gom rung nhiet doi, rung on doi va rung phuong bac; trong khi moi truong song o dai duong bao gom Thai Binh Duong, Dai Tay Duong, An Do Duong, Nam va Bac Bang Duong.*

*Dai duong la noi sinh song cua nhieu loai sinh vat bien da dang, tu nhung sinh vat phu du nho nhat den nhung loai ca voi lon nhat. Cac ran san ho duoc tim thay o vung bien nhiet doi la nhung "thanh pho duoi nuoc" soi dong. Trong khi do, cac khu rung lai co rat nhieu su da dang sinh hoc, voi mot kho tang dong thuc vat, bao gom cay coi, dong vat co vu, chim, con trung, dong vat luong cu (ech, ky nhong), v.v.*
