...
<task>
**Đề:** Put the words and phrases in the appropriate column.
**Dịch đề:** Xếp các từ và cụm từ vào cột thích hợp.

**Word bank:** surgeon / demanding / repetitive / well-paid / designing / assembly worker / teamwork / software engineer / hand-eye coordination
</task>

<questions type="matching">
| Jobs (Nghề nghiệp) | Job features (Đặc điểm công việc) | Job skills (Kỹ năng làm việc) |
|--------------------|-----------------------------------|-------------------------------|
| ___ | ___ | ___ |
| ___ | ___ | ___ |
</questions>
...
**Bài 1 - Đáp án:**
**Jobs (Nghề nghiệp):**
surgeon / assembly worker / software engineer / designing

**Job features (Đặc điểm công việc):**
demanding / repetitive / well-paid
...
<explanation>
**Jobs — Nghề nghiệp:** surgeon (bác sĩ phẫu thuật), assembly worker (công nhân lắp ráp), software engineer (kỹ sư phần mềm), designing (thiết kế) — đây là các từ chỉ tên công việc hoặc lĩnh vực làm việc cụ thể.

**Job features — Đặc điểm công việc:** demanding (đòi hỏi khắt khe), repetitive (lặp đi lặp lại), well-paid (được trả lương cao) — đây là tính từ mô tả bản chất công việc.

**Job skills — Kỹ năng làm việc:** hand-eye coordination (phối hợp tay mắt), teamwork (làm việc theo nhóm) — đây là các kỹ năng cần có để làm việc.
</explanation>
...
<task>
**Đề:** Complete the text, using words / phrases from the box.
**Dịch đề:** Hoàn thành đoạn văn, sử dụng các từ/cụm từ trong khung.

**Word bank:** job / creative / career / rewarding / sewing
</task>
...
<explanation>
**Câu 1:** sewing — may vá, khâu. "My mum first learnt sewing skills from my grandmother." Kỹ năng may vá học từ bà.

**Câu 2:** job — công việc cụ thể. "She got her job as a tailor." Lưu ý: *job* = công việc cụ thể; *career* = sự nghiệp dài hạn.

**Câu 3:** creative — sáng tạo. "She is creative and hardworking." Tính từ mô tả tính cách người thợ may.

**Câu 4:** rewarding — bổ ích, xứng đáng. "She finds her job rewarding." Làm hài lòng khách hàng nên thấy công việc có ý nghĩa.

**Câu 5:** career — sự nghiệp. "A successful career in tailoring." Nói về sự nghiệp lâu dài trong nghề may.
</explanation>
...
<task>
**Đề:** Combine each pair of sentences into one, using the given word in brackets.
**Dịch đề:** Nối mỗi cặp câu thành một, sử dụng từ cho sẵn trong ngoặc.
</task>
...
5. Clara's mum insisted that she go to university although Clara didn't like academic subjects.
</answer>

<explanation>
**Câu 1:** "She accepted the job, though the salary was low." — *though* = mặc dù, đặt giữa câu nối hai vế mâu thuẫn: lương thấp nhưng vẫn chấp nhận.

**Câu 2:** "My sister is such a shy person that she can't be an MC." — "a shy person" là cụm danh từ (a + adj + noun) -> SUCH + a + adj + noun + that. Không phải SO vì SO chỉ đi với tính từ/trạng từ đứng một mình.

**Câu 3:** "He came back to his village because life in the city was too demanding." — *because* chỉ lý do trực tiếp. Cuộc sống thành phố khắt khe -> về làng.

**Câu 4:** "Her backache was so painful that she had to stop working in the factory." — *painful* là tính từ đứng một mình -> SO + adj + that. Đau đến mức phải nghỉ làm.

**Câu 5:** "Clara's mum insisted that she go to university although Clara didn't like academic subjects." — *although* = mặc dù, đặt giữa câu. Mẹ nhất quyết cho đi học mặc dù Clara không thích môn học thuật.
</explanation>
...
<task>
**Đề:** Fill in each gap in the text with a conjunction from the box.
**Dịch đề:** Điền vào mỗi chỗ trống trong văn bản bằng một từ nối trong hộp.

**Word bank:** although / because / since / so / such
</task>
...
<answer>
**Bài 4 - Đáp án:** 1. such | 2. Since | 3. so | 4. because | 5. Although
</answer>

<explanation>
**Câu 1 — such:** "such a difficult process that" — phía sau có cụm danh từ "a difficult process" và "that" -> dùng SUCH. Công thức: such + (a/an) + adj + noun + that.

**Câu 2 — Since:** "Since some parents consider..." — lý do đã ngầm hiểu đứng đầu câu. Cha mẹ cho rằng công việc mơ ước là viển vông -> ngăn cản con. *Since* đặt đầu câu chỉ nguyên nhân.

**Câu 3 — so:** "so demanding that" — phía sau có tính từ "demanding" và "that" -> dùng SO. Công thức: so + adj + that.

**Câu 4 — because:** "just because they overestimate" — chỉ lý do trực tiếp tại sao con căng thẳng: vì cha mẹ đánh giá quá cao khả năng.

**Câu 5 — Although:** "Although parents want to help..." — hai vế mâu thuẫn: muốn giúp con (tốt) nhưng cần hiểu rõ hơn (chưa làm được) -> *although* chỉ sự tương phản.
</explanation>
