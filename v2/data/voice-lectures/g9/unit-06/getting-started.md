...
Ok lớp 9, Unit 6 nha — <eng>Viet Nam: Then and Now</eng>. Hôm nay mình ôn lại quá khứ và hiện tại của Việt Nam luôn. Mở sách ra, bài <eng>Getting Started</eng>, ghi tựa bài vô tập đi. Sau đó bấm "Bắt đầu" để học từ vựng — máy đọc thì đọc theo nha.
</teacher_script>

<vocabulary>
1. **in my day** : (idiom) thời tôi còn trẻ /ɪn maɪ deɪ/
2. **simple** : (adj) đơn giản /ˈsɪmpəl/
3. **cost little** : (phrase) tốn ít tiền /kɒst ˈlɪtəl/
4. **natural material** : (n phrase) vật liệu tự nhiên /ˈnætʃərəl məˈtɪəriəl/
5. **depend on** : (v phrase) phụ thuộc vào /dɪˈpend ɒn/
6. **electronic device** : (n phrase) thiết bị điện tử /ɪˌlekˈtrɒnɪk dɪˈvaɪs/
7. **freedom of choice** : (n phrase) sự tự do lựa chọn /ˈfriːdəm əv tʃɔɪs/
8. **hole** : (n) lỗ hổng /həʊl/
9. **dye** : (v) nhuộm /daɪ/
10. **purple** : (adj/n) màu tím /ˈpɜːpəl/
11. **generation** : (n) thế hệ /ˌdʒenəˈreɪʃən/
12. **opportunity** : (n) cơ hội /ˌɒpəˈtjuːnɪti/
13. **living condition** : (n phrase) điều kiện sống /ˈlɪvɪŋ kənˈdɪʃən/
14. **mostly** : (adv) chủ yếu /ˈməʊstli/
15. **leisure** : (n) thời gian rảnh /ˈleʒə/
