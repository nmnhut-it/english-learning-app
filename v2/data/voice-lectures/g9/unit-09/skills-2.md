...
3. Tự tạo sổ tay từ vựng — chép từ mới, ôn lại dễ dàng
4. Tận dụng mọi cơ hội nói tiếng Anh với mọi người
...
<task>
**Đề:** Listen to Trang talking. Decide if the statements are true (T) or false (F).
**Dịch đề:** Nghe Trang nói. Quyết định xem các câu phát biểu là đúng (T) hay sai (F).
</task>

<questions type="true_false">
**1.** Trang has studied English for seven years. _____
*(Trang đã học tiếng Anh được bảy năm.)*

**2.** She talks about how she has learnt English vocabulary and grammar. _____
*(Cô ấy nói về cách cô ấy học từ vựng và ngữ pháp tiếng Anh.)*

**3.** She has learnt new words from reading English books. _____
*(Cô ấy đã học được từ mới khi đọc sách tiếng Anh.)*

**4.** She is confident about her English vocabulary now. _____
...
<answer>
**Bài 2 - Đáp án:** 1.F | 2.F | 3.T | 4.T
</answer>

<explanation>
**1. F** - Trang học **sáu** năm, không phải bảy. Bài nghe: *"I've learnt English for six years"* → câu này SAI vì nói "seven years".
**2. F** - Trang chỉ nói về cách học **từ vựng**, không đề cập ngữ pháp. Bài nghe: *"Here are some tips I've tried to improve my vocabulary learning."* → câu này SAI vì thêm "and grammar".
**3. T** - Đúng! Phương pháp 1 của Trang: *"I spend time reading different kinds of English books"* → học từ mới từ đọc sách.
**4. T** - Đúng! Câu cuối: *"now I'm quite confident about my English vocabulary."* → bây giờ khá tự tin.
</explanation>

---

<!-- chunk: exercise_3 -->
### Bài 3 trang 39 - Fill in blanks from audio

<audio src="https://img.loigiaihay.com/picture/2024/0515/58.mp3">
...
<task>
**Đề:** Listen again and fill in each blank with no more than TWO words.
**Dịch đề:** Nghe lại và điền vào mỗi chỗ trống không quá HAI từ.
</task>
...
<explanation>
**1. meaning** - *"I try to guess its meaning from the sentence."* → đoán **nghĩa** của từ.
**2. pronunciation** - *"check its meaning and pronunciation in the dictionary."* → kiểm tra nghĩa và **phát âm**.
**3. Copying** - *"I have the habit of copying all new words into a notebook."* → **chép** tất cả từ mới vào sổ.
**4. Speaking** - *"I take every opportunity to speak with people in English."* → **Nói** bằng tiếng Anh.
**5. picking up** - *"pick up more new words from these conversations."* → **nhặt thêm** từ mới từ hội thoại. *Pick up* = học/thu nhặt một cách tự nhiên.
</explanation>
...
<task>
**Đề:** Work in pairs. Discuss the questions below.
**Dịch đề:** Làm việc theo cặp. Thảo luận các câu hỏi dưới đây.
</task>
...
<task>
**Đề:** Write a paragraph (100-120 words) about the most challenging thing you face when learning English and what you have done to improve it.
**Dịch đề:** Viết một đoạn văn (100-120 từ) về thử thách lớn nhất mà bạn gặp phải khi học tiếng Anh và bạn đã làm gì để cải thiện nó.
