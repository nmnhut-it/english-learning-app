...
<vocabulary>
1. **throw away** : (phr v) vứt bỏ /θrəʊ əˈweɪ/
2. **leftover** : (n) thức ăn thừa /ˈleftəʊvər/
3. **biogas** : (n) khí sinh học /ˈbaɪəʊɡæs/
4. **process** : (v) xử lý, chế biến /ˈprəʊses/
5. **bookworm** : (n) mọt sách, người hay đọc sách /ˈbʊkwɜːm/
6. **public amenity** : (n) tiện ích công cộng /ˈpʌblɪk əˈmiːnəti/
7. **particularly** : (adv) đặc biệt, nhất là /pəˈtɪkjʊləli/
8. **suggest** : (v) đề nghị, gợi ý /səˈdʒest/
9. **lively** : (adj) sôi động, nhộn nhịp /ˈlaɪvli/
10. **dessert** : (n) tráng miệng /dɪˈzɜːt/
11. **cafeteria** : (n) căng tin, quán ăn tự chọn /ˌkæfəˈtɪəriə/
12. **vehicle** : (n) phương tiện giao thông /ˈviːɪkl/
13. **drop-off** : (n) chỗ thả khách /ˈdrɒp ɒf/
14. **pick-up** : (n) chỗ đón khách /ˈpɪk ʌp/
15. **in addition** : (phr) ngoài ra, thêm vào đó /ɪn əˈdɪʃən/
16. **realise** : (v) nhận ra, hiểu ra /ˈrɪəlaɪz/
</vocabulary>

<teacher_script pause="0">
Ghi từ vựng vô tập xong chưa? Chú ý "dessert" — tráng miệng — có hai chữ "s" nha, đừng nhầm với "desert" — sa mạc — chỉ một chữ "s" thôi. Giờ vô bài đọc nha!
</teacher_script>
...
Đọc kỹ bài một lần nữa và dịch ra nha. Ba phút.
</teacher_script>
...
<teacher_script pause="0">
<eng>Exercise 4</eng> — nói nha! Thảo luận về các vấn đề trong thành phố Việt Nam. Nhìn bảng bên dưới, nêu giải pháp cho mỗi vấn đề rồi thảo luận xem vấn đề nào nghiêm trọng nhất.
</teacher_script>

<task>
**Đề:** Look at the table of city problems. Discuss solutions for each and decide which is the most serious problem in Vietnamese cities.
**Dịch đề:** Nhìn vào bảng các vấn đề thành phố. Thảo luận giải pháp và quyết định vấn đề nào nghiêm trọng nhất ở các thành phố Việt Nam.
</task>

<questions type="speaking">
| Vấn đề | Giải pháp gợi ý |
|---|---|
| Đường phố bẩn *(dirty streets)* | Thêm thùng rác, tăng cường dọn vệ sinh, phạt xả rác |
| Thiếu cây xanh *(lack of green space)* | Trồng cây, làm vườn trên mái nhà, xây công viên |
| Lấn chiếm vỉa hè *(pavement encroachment)* | Phạt tiền, giải phóng vỉa hè, kiểm tra thường xuyên |
| Vượt đèn đỏ *(running red lights)* | Lắp camera, tăng mức phạt, giáo dục giao thông |

**Câu hỏi thảo luận:**
- Which problem is most serious in your city?
- What solution do you think is most effective?
</questions>

<!-- chunk: exercise-5-speaking-model -->
<teacher_script pause="0">
<eng>Exercise 5</eng> — nói về vấn đề giao thông thành phố nha. Đây là đoạn mẫu, đọc qua rồi tự nói theo ý của em.
</teacher_script>

<task>
**Đề:** Use the model paragraph below to talk about a city problem and its solution. Then present your own ideas.
**Dịch đề:** Dùng đoạn mẫu bên dưới để nói về vấn đề thành phố và giải pháp. Sau đó trình bày ý kiến của em.
</task>

<questions type="speaking">
**Đoạn mẫu:**

*"One of the biggest problems in Ho Chi Minh City is traffic congestion. During rush hour, millions of motorbikes and cars crowd the streets, making it difficult to get around. The city could solve this by investing in a modern metro system and encouraging people to use public transport. In addition, the government should enforce traffic laws more strictly."*

**Bây giờ em nói về một vấn đề ở thành phố em đang sống:**
- What is the problem?
- Why does it happen?
