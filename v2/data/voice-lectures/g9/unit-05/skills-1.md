...
Ok lớp 9, bài <eng>Skills 1</eng> Unit 5 — đọc và nói nha. Hôm nay đọc hai bài viết của Dương và Akiko về những trải nghiệm mùa hè đặc biệt của họ. Học từ vựng trước, bấm "Bắt đầu" nha.
</teacher_script>

<vocabulary>
1. **army camp** : (n) trại quân đội /ˈɑːmi kæmp/
2. **wake up** : (phr v) thức dậy /weɪk ʌp/
3. **training course** : (n) khóa huấn luyện /ˈtreɪnɪŋ kɔːs/
4. **soldier** : (n) lính, quân nhân /ˈsəʊldʒə/
5. **touching** : (adj) cảm động /ˈtʌtʃɪŋ/
6. **strict** : (adj) nghiêm khắc /strɪkt/
7. **unforgettable** : (adj) khó quên /ˌʌnfəˈɡetəbl/
8. **campus** : (n) khuôn viên trường /ˈkæmpəs/
...
<teacher_script pause="0">
Xong từ vựng rồi nha. Ghi vô tập, rồi mình đọc hai bài chia sẻ trải nghiệm thôi.
</teacher_script>

<!-- chunk: reading-1 -->
<teacher_script pause="0">
Bài đọc thứ nhất là của Dương — kể về trải nghiệm đến trại quân sự mùa hè. Đọc kỹ và ghi nhớ các chi tiết quan trọng nha.
</teacher_script>
...
Dịch cả hai bài đọc vô vở nha. 3 phút.
</teacher_script>
