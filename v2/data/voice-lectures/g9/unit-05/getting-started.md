...
<explanation>
**1. F** — Tom đi Đà Lạt cùng gia đình, không phải cùng Mi. Mi ở nhà và chỉ nghe Tom kể lại → Sai.

**2. T** — "Then we took an eco-tour of Langbiang Mountain." → Tom đã đi du lịch sinh thái núi Langbiang → Đúng.

**3. T** — "the area is rich in flora and fauna with more than 150 plant and animal species." → hơn 150 loài → Đúng.

**4. F** — Tom nói "We had a brilliant tour around the village" và "It definitely was [exciting]" → Tom thích trải nghiệm ở làng Cù Lần → Sai.

**5. T** — "We danced and sang with the locals." tại buổi biểu diễn cồng chiêng → Đúng.
</explanation>

<!-- chunk: exercise-3 -->
<teacher_script pause="60">
Bài 3 — viết hoạt động dưới tranh nha. Dùng các từ trong hộp. 1 phút.
</teacher_script>

<task>
**Đề:** Write activities under the pictures.
**Dịch đề:** Viết các hoạt động dưới các bức tranh.
</task>
...
<!-- chunk: exercise-4 -->
<teacher_script pause="60">
Bài 4 — đọc lại hội thoại và nối hoạt động với tính từ mô tả nha. 1 phút.
</teacher_script>

<task>
**Đề:** Read the conversation again and match the activities with the adjectives.
**Dịch đề:** Đọc lại đoạn hội thoại và nối các hoạt động với các tính từ.
</task>

<questions type="matching">
| Activity | Adjective |
|---|---|
| 1. riding a jeep | a. enjoyable |
| 2. seeing a gong show | b. thrilling |
| 3. taking an eco-tour | c. amazing |
| 4. exploring a site | d. interesting |
| 5. taking pictures | e. brilliant |
</questions>
...
<answer>
**Bài 4 - Đáp án:** 1-b | 2-d | 3-c | 4-e | 5-a
</answer>

<explanation>
**1-b. riding a jeep: thrilling** — "We rode a jeep to the top. It was a **thrilling** ride up there."

**2-d. seeing a gong show: interesting** — "we saw an **interesting** gong show."

**3-c. taking an eco-tour: amazing** — Mi nói "Sounds **amazing**!" sau khi Tom kể về eco-tour.

**4-e. exploring a site: brilliant** — "We had a **brilliant** tour around the village."

**5-a. taking pictures: enjoyable** — "We took pictures of the magnificent scenery, It was really **enjoyable**!"
</explanation>

<!-- chunk: exercise-5 -->
<teacher_script pause="120">
Bài 5 — <eng>Speaking</eng> nha. Làm việc theo nhóm, thực hiện khảo sát về các hoạt động du lịch. Hỏi bạn bè *"Do you like...?"* rồi báo cáo kết quả trước lớp. 2 phút.
</teacher_script>

<task>
**Đề:** Work in groups. Carry out a survey. Then report your group's findings to the class.
**Dịch đề:** Làm việc theo nhóm. Thực hiện một cuộc khảo sát. Sau đó báo cáo kết quả của nhóm bạn trước lớp.
</task>
...
| 5. seeing a tribal dance show *(xem chương trình khiêu vũ của bộ lạc)* | | |
</questions>

<teacher_script pause="0">
Hay lắm nha! Xong bài <eng>Getting Started</eng> Unit 5 rồi. Tụi mình đã học từ vựng về du lịch và thiên nhiên, đọc hội thoại về chuyến đi Đà Lạt của Tom, và làm các bài tập. Nhớ các từ: thrilling, magnificent, eco-tour, flora, fauna nha! Hẹn gặp ở bài <eng>A Closer Look 1</eng> nghen!
</teacher_script>
