...
<teacher_script pause="0">
Bài 1 <eng>Match the electronic devices (1-6) with their descriptions (a-f)</eng> nha. Nối các thiết bị điện tử (1-6) với mô tả (a-f) phù hợp. Các em đọc kỹ mô tả rồi chọn thiết bị đúng nha.
</teacher_script>

<task>
**De:** Match the electronic devices (1-6) with their descriptions (a-f).

**Dich de:** Nối các thiết bị điện tử (1-6) với mô tả (a-f) phù hợp.
</task>
...
<teacher_script pause="0">
Bài 2 <eng>Complete each sentence with the name of a material from the box</eng> nha. Hoàn thành mỗi câu với tên vật liệu trong khung. Các em đọc mô tả rồi đoán xem đó là vật liệu gì nha.
</teacher_script>

<task>
**De:** Complete each sentence with the name of a material from the box.

**Dich de:** Hoàn thành mỗi câu với tên vật liệu trong khung.
</task>
...
<answer>
**Dap an:** 1. rubber | 2. steel | 3. 3D printers | 4. cardboard | 5. camcorders
</answer>
