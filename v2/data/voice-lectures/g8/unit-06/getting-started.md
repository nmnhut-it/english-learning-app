# UNIT 6: LIFESTYLES
## GETTING STARTED - Different Lifestyles

<!-- chunk: vocabulary -->
<teacher_script pause="0">
Ok lớp 8, Unit 6 nha - LIFESTYLES - Lối sống. Mở sách trang đầu Unit 6 đi. Ghi tựa bài <eng>Getting Started - Different Lifestyles</eng> vô tập. Sau đó bấm nút "Bắt đầu" bên dưới để học từ vựng. Máy sẽ đọc và các em đọc theo. Xong rồi làm bài trắc nghiệm từ vựng rồi ghi từ vựng vô tập nha.
</teacher_script>

<vocabulary>
1. **lifestyle** : (n) lối sống /ˈlaɪfstaɪl/
2. **greet** : (v) chào hỏi /ɡriːt/
3. **surname** : (n) họ (trong tên người) /ˈsɜːneɪm/
4. **title** : (n) danh hiệu, chức danh /ˈtaɪtl/
5. **common practice** : (n) thói quen/tập tục chung /ˈkɒmən ˈpræktɪs/
6. **restaurant** : (n) nhà hàng /ˈrestrɒnt/
7. **notice** : (v) nhận thấy, để ý /ˈnoʊtɪs/
8. **typically** : (adv) thông thường, thường lệ /ˈtɪpɪkli/
9. **habit** : (n) thói quen /ˈhæbɪt/
10. **fascinating** : (adj) hấp dẫn, thú vị /ˈfæsɪneɪtɪŋ/
11. **handshake** : (n) bắt tay /ˈhændʃeɪk/
12. **bow** : (v) cúi đầu (chào) /baʊ/
13. **hug** : (v/n) ôm /hʌɡ/
14. **balanced diet** : (n) chế độ ăn cân đối /ˈbælənst ˈdaɪət/
15. **serve** : (v) phục vụ /sɜːv/
16. **street food** : (n) thức ăn đường phố /striːt fuːd/
</vocabulary>
...
Ok bài 2 nha. Nhìn vào bảng, điền thông tin về đất nước của Nam và Tom dựa vào hội thoại vừa đọc. 1 phút đi.
</teacher_script>
...
<!-- chunk: exercise-3 -->
<teacher_script pause="60">
Bài 3 nha. Điền từ vào chỗ trống. Dùng những từ này: <eng>lifestyle / greet / serve / practice / habit</eng>. 1 phút đi.
</teacher_script>
...
<!-- chunk: end -->
<teacher_script pause="0">
Xong bài <eng>Getting Started</eng> rồi nha. Các em đã biết từ vựng về lối sống và các thói quen ở những đất nước khác nhau. Bài sau mình học <eng>A Closer Look 1</eng> về từ vựng và phát âm. Hẹn gặp lại nhé!
</teacher_script>
