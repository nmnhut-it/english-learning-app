...
2. **what's the matter** : (phrase) có chuyện gì vậy /wɒts ðə ˈmætər/
3. **home town** : (n) quê hương, quê nhà /ˈhoʊm taʊn/
4. **affect** : (v) ảnh hưởng đến /əˈfekt/
5. **flood** : (n/v) lũ lụt /flʌd/
6. **natural disaster** : (n) thảm họa thiên nhiên /ˈnætʃərəl dɪˈzɑːstər/
7. **tornado** : (n) lốc xoáy /tɔːrˈneɪdoʊ/
8. **storm** : (n) bão /stɔːrm/
9. **violent storm** : (n) cơn bão dữ dội /ˈvaɪələnt stɔːrm/
10. **strong wind** : (n) gió mạnh /strɒŋ wɪnd/
11. **move in a circle** : (phrase) di chuyển theo vòng tròn /muːv ɪn ə ˈsɜːrkəl/
