...
<vocabulary>
1. **commune** : (n) xã, địa phương /ˈkɒmjuːn/
2. **radio station** : (n) đài phát thanh /ˈreɪdioʊ ˈsteɪʃən/
3. **rainy season** : (n) mùa mưa /ˈreɪni ˈsiːzən/
4. **special programme** : (n) chương trình đặc biệt /ˈspeʃəl ˈproʊɡræm/
5. **prepare** : (v) chuẩn bị /prɪˈpeər/
6. **emergency kit** : (n) bộ dụng cụ khẩn cấp /ɪˈmɜːrdʒənsi kɪt/
