...
Ok lớp 8, hôm nay mình học <eng>Skills 1</eng> Unit 1 nha. Phần này đọc hiểu về các hoạt động giải trí và luyện nói. Mở sách trang 14 đi!
</teacher_script>

<!-- chunk: vocabulary -->
<teacher_script pause="0">
Các em mở sách ra, Unit 1, bài <eng>Skills 1</eng>, ghi tựa bài. Bấm "Bắt đầu" để học từ vựng trước khi đọc bài.
</teacher_script>

<vocabulary>
1. **leisure activities** : (n) các hoạt động giải trí /ˈlɛʒər ækˈtɪvɪtiz/
2. **family members** : (n) các thành viên trong gia đình /ˈfæmɪli ˈmɛmbəz/
3. **connect with** : (v) kết nối với /kəˈnɛkt wɪð/
4. **bike ride** : (n) chuyến đi xe đạp /baɪk raɪd/
5. **nearby villages** : (n) các làng lân cận /ˈnɪəbaɪ ˈvɪlɪdʒɪz/
6. **fresh air** : (n) không khí trong lành /frɛʃ ɛər/
7. **take photos** : (v.phr) chụp ảnh /teɪk ˈfəʊtəʊz/
8. **easy recipes** : (n) công thức nấu ăn đơn giản /ˈiːzi ˈrɛsɪpiz/
9. **prepare ingredients** : (v.phr) chuẩn bị nguyên liệu /prɪˈpeər ɪnˈɡriːdiənts/
10. **DIY projects** : (n) các dự án tự làm /ˌdiː.aɪˈwaɏ ˈprɒdʒɛkts/
11. **make dresses** : (v.phr) may váy /meɪk ˈdrɛsɪz/
12. **special occasions** : (n) các dịp đặc biệt /ˈspɛʃəl əˈkeɪʒənz/
13. **costume contest** : (n) cuộc thi trang phục /ˈkɒstjuːm ˈkɒntɛst/
14. **first prize** : (n) giải nhất /fɜːst praɪz/
</vocabulary>
...
Bài 3. Đọc lại bài và trả lời câu hỏi nha. 1 phút.
</teacher_script>
...
<!-- chunk: speaking -->
### Bài 4 trang 14 - Speaking

<teacher_script pause="0">
Bài 4 nói về hoạt động giải trí của gia đình em nha. Trả lời các câu hỏi.
</teacher_script>

<task>
**Đề:** Talk about leisure activities in your family. Answer these questions.
**Dịch đề:** Nói về các hoạt động giải trí trong gia đình em. Trả lời các câu hỏi.
</task>
...
<teacher_script pause="0">
Mẫu trả lời nha:
1. "We usually play badminton / go cycling / cook together."
2. "The leisure activity I like most is... because it's..."
3. "I feel happy/relaxed/excited when I..."
</teacher_script>

<answer>
**Mẫu trả lời:**
1. We usually play badminton together.
2. The leisure activity I like most is riding bikes because it's good for my health.
3. I feel happy and relaxed.
</answer>

<teacher_script action="record">
Các em trả lời 3 câu hỏi trên về gia đình mình nha. Bấm nút ghi âm khi sẵn sàng.
</teacher_script>
