...
Ok Unit 4, bài <eng>Skills 1</eng> nha. Mở sách trang 44. Bài này đọc hiểu về nhà sàn và nói về nhà ở. Trước tiên học từ vựng. Bấm "Bắt đầu", máy đọc thì đọc theo, làm quiz rồi ghi từ vô tập.
</teacher_script>

<vocabulary>
1. **stilt house** : (n) nhà sàn /stɪlt haʊs/
2. **popular** : (adj) phổ biến, được ưa chuộng /ˈpɒpjʊlər/
3. **highland** : (n) vùng cao, cao nguyên /ˈhaɪlənd/
4. **delta** : (n) đồng bằng châu thổ /ˈdeltə/
5. **material** : (n) vật liệu /məˈtɪəriəl/
6. **post** : (n) cây cột, trụ đỡ /pəʊst/
7. **in the middle of** : (prep) ở giữa /ɪn ðə ˈmɪdl ɒv/
8. **family gathering** : (n) đoàn tụ gia đình /ˈfæmɪli ˈɡæðərɪŋ/
9. **receive guests** : (v) tiếp khách /rɪˈsiːv ɡests/
10. **overlook** : (v) nhìn ra, hướng ra /ˌəʊvəˈlʊk/
11. **communal house** : (n) nhà cộng đồng /kəˈmjuːnəl haʊs/
</vocabulary>

<!-- chunk: pre-reading -->
<teacher_script pause="0">
Trước khi đọc bài — nhìn các loại nhà trong sách và trả lời câu hỏi gợi ý. Có mấy loại nhà này nha: nhà sàn, nhà tre, nhà cộng đồng, nhà hiện đại. Các em hay ở loại nhà nào?
</teacher_script>

<task>
**Đề:** Look at the pictures of different types of houses. Which type do you live in? Which would you like to visit?
**Dịch đề:** Nhìn các loại nhà. Bạn đang sống trong loại nhà nào? Bạn muốn thăm loại nhà nào?

*Các loại nhà phổ biến:*
- Stilt house *(nhà sàn)*
- Bamboo house *(nhà tre)*
- Brick house / detached house *(nhà gạch / nhà độc lập)*
- Multi-storey home *(nhà nhiều tầng)*
- Flat / apartment *(căn hộ chung cư)*
- Farmhouse *(nhà nông thôn)*
- Town house *(nhà phố)*
</task>

<questions type="speaking">
**Gợi ý:**
> *I live in a multi-storey home in the city.*
> *I'd love to visit a stilt house in the highlands.*
</questions>

<!-- chunk: reading -->
<teacher_script pause="0">
Ok bây giờ đọc bài về nhà sàn. Đọc kỹ, chú ý thông tin về: loại nhà sàn, vật liệu, chức năng. Cho 3 phút đọc thầm.
</teacher_script>
...
Đọc và dịch bài văn vô vở. Chú ý các thông tin quan trọng. Cho 3 phút nha.
</teacher_script>

<!-- chunk: exercise-1 -->
<teacher_script pause="0">
Bài 1 — đúng (T) hay sai (F) dựa vào bài đọc? Cho 2 phút nha.
</teacher_script>

<task>
**Đề:** Read the text again and write True (T) or False (F). Correct the false sentences.
**Dịch đề:** Đọc lại bài và viết T hoặc F. Sửa các câu sai.
</task>
...
<!-- chunk: exercise-2 -->
<teacher_script pause="0">
Bài 2 — điền vào chỗ trống dựa vào bài đọc. Cho 3 phút nha.
</teacher_script>

<task>
**Đề:** Fill in the blanks with information from the reading.
**Dịch đề:** Điền vào chỗ trống dựa vào thông tin trong bài đọc.
</task>
...
<!-- chunk: speaking -->
<teacher_script pause="0">
Phần nói nha. Bài 3 — nói về loại nhà bạn đang sống và những việc bạn làm để giúp gia đình. Luyện nói theo cặp, sau đó một vài bạn trình bày trước lớp. Dùng mẫu câu gợi ý nha.
</teacher_script>

<task>
**Đề:** Talk about your home and what you do to help your family. Use the prompts below.
**Dịch đề:** Nói về ngôi nhà của bạn và những việc bạn làm để giúp gia đình.
</task>
...
*About your home:*
- I live in a _______ (type of house) in _______ (city/area).
- My house has _______ floors / rooms.
- My favourite room is _______ because _______.

*About helping your family:*
- I usually help my family by _______.
- I am responsible for _______.
- At weekends, I _______.

**Housework vocabulary:**
- cook meals *(nấu ăn)*
- wash the dishes *(rửa chén)*
- do the laundry *(giặt đồ)*
- prepare vegetables *(nhặt rau)*
- clean the house *(dọn nhà)*
- take out the rubbish *(đổ rác)*
- look after younger siblings *(trông em)*
- water the plants *(tưới cây)*
</questions>

<teacher_script pause="180">
Nói chuyện với bạn bên cạnh về nhà của bạn và việc nhà bạn làm. Cho 3 phút rồi vài bạn chia sẻ trước lớp nha.
</teacher_script>

<!-- chunk: writing -->
<teacher_script pause="0">
Bài 4 — viết đoạn văn về những việc bạn làm để giúp gia đình. Đọc đoạn văn mẫu trước rồi tự viết nha.
</teacher_script>

<task>
**Đề:** Write a paragraph (60–80 words) about the things you do to help your family at home.
**Dịch đề:** Viết một đoạn văn (60–80 chữ) về những việc bạn làm để giúp gia đình ở nhà.

**Gợi ý dàn ý:**
1. Câu mở đầu: bạn thường giúp gia đình như thế nào
2. Liệt kê 3–4 việc cụ thể (dùng: firstly, second, also, sometimes)
3. Câu kết: tại sao làm việc nhà quan trọng
</task>

<reading>
**Đoạn văn mẫu:**

I usually help my family do things at home. Firstly, I prepare food and sometimes help my mother cook meals. Second, I usually take responsibility for doing the dishes after meals. I also do the laundry at weekends. Sometimes, I help with cleaning the house, too. Housework keeps our family close together and teaches me useful life skills.
</reading>

<teacher_script pause="300">
Giờ tự viết đoạn văn của mình vô vở. Dùng cấu trúc mẫu và từ vựng việc nhà vừa học. Cho 5 phút nha. Viết xong đưa bạn đọc kiểm tra lỗi.
</teacher_script>

<!-- chunk: end -->
<teacher_script pause="0">
Xong bài <eng>Skills 1</eng> rồi nha! Hôm nay mình đọc về nhà sàn — loại nhà độc đáo của nhiều dân tộc Việt Nam. Và luyện nói + viết về nhà ở và việc nhà. Tiết sau vào <eng>Skills 2</eng> nghe và viết nha. Cất tập lại.
</teacher_script>
