...
<vocabulary>
1. **ancient** : (adj) cổ kính, lâu đời /ˈeɪnʃənt/
2. **situated** : (v) được đặt ở /ˈsɪtʃueɪtɪd/
3. **famous** : (adj) nổi tiếng /ˈfeɪməs/
4. **pagoda** : (n) chùa /pəˈɡəʊdə/
5. **temple** : (n) đền /ˈtɛmpl/
6. **observe** : (v) quan sát /əbˈzɜːv/
7. **locals** : (n) người địa phương /ˈləʊklz/
8. **specialties** : (n) đặc sản /ˈspɛʃəltiz/
9. **historical** : (adj) lịch sử /hɪˈstɒrɪkl/
10. **cultural values** : (n.phr) giá trị văn hóa /ˈkʌltʃərəl ˈvæljuːz/
11. **lighthouse** : (n) ngọn hải đăng /ˈlaɪthaʊs/
12. **sightseeing** : (n) tham quan /ˈsaɪtsiːɪŋ/
13. **kite-flying** : (n) thả diều /kaɪt ˈflaɪɪŋ/
