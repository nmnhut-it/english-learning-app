...
Ok lớp 8, hôm nay mình học <eng>Skills 1</eng> Unit 2 nha. Phần này đọc về cuộc sống ở một huyện miền Tây và luyện nói về nông thôn. Mở sách trang 24 đi!
</teacher_script>

<!-- chunk: vocabulary -->
<teacher_script pause="0">
Học từ vựng trước khi đọc nha. Bấm "Bắt đầu".
</teacher_script>

<vocabulary>
1. **peaceful** : (adj) yên bình /ˈpiːsfl/
2. **vast** : (adj) rộng lớn, bao la /vɑːst/
3. **crowd** : (n) đám đông /kraʊd/
4. **noise** : (n) tiếng ồn /nɔɪz/
5. **stretch** : (v) trải dài /strɛtʃ/
6. **canal** : (n) kênh đào /kəˈnæl/
7. **cultivate** : (v) trồng trọt, canh tác /ˈkʌltɪveɪt/
8. **orchard** : (n) vườn cây ăn quả /ˈɔːtʃəd/
9. **get along** : (v.phr) hòa hợp với nhau /ɡɛt əˈlɒŋ/
10. **calm** : (adj) yên lặng, bình yên /kɑːm/
11. **relationship** : (n) mối quan hệ /rɪˈleɪʃənʃɪp/
12. **special features** : (n.phr) đặc điểm đặc biệt /ˈspɛʃəl ˈfiːtʃərz/
</vocabulary>
...
<!-- chunk: exercise_3 -->
### Bài 3 trang 24 - True/False

<teacher_script pause="60">
Bài 3. Đọc lại và cho biết câu nào đúng (T), câu nào sai (F) nha. 1 phút.
</teacher_script>
