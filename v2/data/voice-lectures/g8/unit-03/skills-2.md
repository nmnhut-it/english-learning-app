# UNIT 3: TEENAGERS
## SKILLS 2 - Teenage Stress: Listening & Writing

<!-- chunk: vocabulary -->
<teacher_script pause="0">
Ok lớp 8, bài <eng>Skills 2</eng> nha — nghe và viết về vấn đề tuổi teen. Học từ vựng trước rồi mình nghe 3 bạn học sinh nói về áp lực của các bạn ấy. Bấm "Bắt đầu" đi.
</teacher_script>

<vocabulary>
1. **stress** : (n) căng thẳng /stres/
2. **expectations** : (n) kỳ vọng /ˌekspekˈteɪʃənz/
3. **tired** : (adj) mệt mỏi /ˈtaɪəd/
4. **pressure** : (n) áp lực /ˈpreʃə/
5. **interests** : (n) sở thích /ˈɪntrəsts/
6. **abilities** : (n) khả năng /əˈbɪlɪtɪz/
7. **focus** : (v) tập trung vào /ˈfəʊkəs/
8. **jealous** : (adj) ghen tỵ /ˈdʒeləs/
9. **arguments** : (n) cuộc tranh cãi /ˈɑːɡjʊmənts/
...
<teacher_script pause="0">
Nghe xong rồi nha. Mình dịch nhanh để hiểu nội dung.
</teacher_script>
...
<!-- chunk: writing -->
<teacher_script pause="0">
Giờ mình đến phần viết — bài 4 nha. Viết một đoạn văn ngắn về một vấn đề của tuổi teen và đề xuất giải pháp. Thầy/cô đọc ví dụ mẫu trước nha.
</teacher_script>

<task>
**Đề:** Write a paragraph (80–100 words) about a teenage problem and suggest solutions.
**Dịch đề:** Viết một đoạn văn (80–100 từ) về một vấn đề của tuổi teen và đề xuất giải pháp.

**Gợi ý chủ đề:**
- Peer pressure (áp lực từ bạn bè)
- Stress about exams (căng thẳng về bài thi)
- Social media addiction (nghiện mạng xã hội)
- Parental expectations (kỳ vọng từ ba mẹ)

**Cấu trúc đoạn văn:**
1. **Câu chủ đề:** Nêu vấn đề là gì
2. **Nguyên nhân:** Tại sao vấn đề này xảy ra
3. **Tác hại:** Vấn đề này ảnh hưởng như thế nào
4. **Giải pháp:** Làm gì để giải quyết
5. **Câu kết:** Kết luận chung

**Bài mẫu:**
*Many teenagers today feel stressed about their exams. They have to study for many subjects and their parents often have high expectations. This causes them to lose sleep and feel anxious. However, there are some ways to deal with exam stress. Students should make a study plan and take short breaks. They should also talk to their parents about how they feel. With good planning and support, teenagers can manage exam stress and do well in school.*
</task>

<teacher_script action="photo">
Viết đoạn văn vô vở nha. Thầy/cô cho 8 phút để viết. Chụp ảnh bài để nộp khi xong.
</teacher_script>

<!-- chunk: end -->
<teacher_script pause="0">
Xong bài <eng>Skills 2</eng> rồi nha! Hôm nay mình luyện nghe về vấn đề tuổi teen — áp lực ba mẹ, sở thích bản thân, ghen tỵ và mạng xã hội. Rồi mình viết đoạn văn về cách giải quyết vấn đề đó. Về nhà viết lại đoạn văn cho hoàn chỉnh nha. Tiết sau học bài <eng>Looking Back</eng> — ôn tập toàn bộ Unit 3!
</teacher_script>
