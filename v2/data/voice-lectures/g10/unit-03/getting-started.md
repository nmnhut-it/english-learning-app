...
Ok lớp 10, hôm nay mình học bài <eng>Getting Started</eng> Unit 3: <eng>Music</eng> nha. Bài này nói về một nghệ sĩ tài năng. Mở sách trang 28 đi.
</teacher_script>
...
<vocabulary>
1. **pop singer** : (n) ca sĩ nhạc pop /pɒp ˈsɪŋə(r)/
2. **teen idol** : (n) thần tượng tuổi teen /tiːn ˈaɪdl/
3. **talented** : (adj) tài năng /ˈtæləntɪd/
4. **artist** : (n) nghệ sĩ /ˈɑːtɪst/
5. **musical instruments** : (n.p) nhạc cụ /ˈmjuːzɪkl ˈɪnstrəmənts/
6. **award** : (n) giải thưởng /əˈwɔːd/
7. **perform** : (v) biểu diễn /pəˈfɔːm/
8. **upload** : (v) đăng tải /ˌʌpˈləʊd/
9. **cover song** : (n) bài hát cover /ˈkʌvə(r) sɒŋ/
10. **social media** : (n) mạng xã hội /ˈsəʊʃl ˈmiːdiə/
11. **billion** : (n) tỷ /ˈbɪljən/
12. **views** : (n) lượt xem /vjuːz/
</vocabulary>

<!-- chunk: dialogue -->
<teacher_script pause="0">
Giờ nghe và đọc hội thoại giữa Mai và Ann nha.
</teacher_script>
...
<!-- chunk: exercise_2 -->
### Bài 2 trang 29 - Comprehension

<teacher_script pause="60">
Bài 2: Đọc lại rồi trả lời câu hỏi nha. 1 phút.
</teacher_script>
...
<answer>
**Đáp án:**
1. They are talking about a popular teen idol / a talented pop singer.
2. He can write music and play many musical instruments (piano, drums, guitar, and trumpet).
3. His mother uploaded his cover song videos on social media, and the videos made him an online star.
</answer>

<explanation>
**1.** Ann và Mai đang nói về một thần tượng tuổi teen / ca sĩ nhạc pop tài năng.
**2.** Anh ấy có thể viết nhạc và chơi nhiều nhạc cụ: piano, trống, guitar, kèn trumpet.
**3.** Mẹ anh đăng video cover lên mạng xã hội, video giúp anh trở thành ngôi sao trực tuyến.
</explanation>

<!-- chunk: exercise_3 -->
### Bài 3 trang 29 - Matching

<teacher_script pause="45">
Bài 3: Nối từ với nghĩa nha. 45 giây.
</teacher_script>

<task>
**Đề:** Match the words in A with their meanings in B.
**Dịch đề:** Nối các từ trong cột A với nghĩa trong cột B.
</task>
...
a. a popular and successful song
b. a famous person who is admired
c. an object used for producing music
...
<explanation>
**1-b:** idol = a famous person who is admired (thần tượng = người nổi tiếng được ngưỡng mộ)
**2-d:** fan = a person who admires someone very much (fan = người rất hâm mộ ai đó)
**3-c:** instrument = an object used for producing music (nhạc cụ = vật dùng để tạo ra âm nhạc)
**4-a:** hit = a popular and successful song (bài hit = bài hát phổ biến và thành công)
</explanation>

<!-- chunk: end -->
<teacher_script pause="0">
Bài <eng>Getting Started</eng> Unit 3 xong rồi nha. Nhớ từ vựng về âm nhạc: <eng>artist, idol, fan, instrument, hit, perform, award</eng>. Ôn bài hen!
</teacher_script>
