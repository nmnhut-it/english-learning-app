...
Ok lớp 10, hôm nay mình học bài <eng>Getting Started</eng> Unit 2: <eng>Humans and the Environment</eng> nha. Bài này nói về câu lạc bộ sống xanh. Mở sách trang 18 đi.
</teacher_script>
...
<vocabulary>
1. **go green** : (v.p) sống xanh /ɡəʊ ɡriːn/
2. **club** : (n) câu lạc bộ /klʌb/
3. **Youth Union** : (n) Đoàn Thanh niên /juːθ ˈjuːniən/
4. **aim** : (n) mục tiêu /eɪm/
5. **improve** : (v) cải thiện /ɪmˈpruːv/
6. **environment** : (n) môi trường /ɪnˈvaɪrənmənt/
7. **encourage** : (v) khuyến khích /ɪnˈkʌrɪdʒ/
8. **lifestyle** : (n) lối sống /ˈlaɪfstaɪl/
9. **ceremony** : (n) buổi lễ /ˈserəməni/
10. **clean up** : (phr.v) dọn dẹp /kliːn ʌp/
11. **organise** : (v) tổ chức /ˈɔːɡənaɪz/
12. **raise awareness** : (v.p) nâng cao nhận thức /reɪz əˈweənəs/
13. **environmental issues** : (n.p) vấn đề môi trường /ɪnˌvaɪrənˈmentl ˈɪʃuːz/
14. **reduce** : (v) giảm /rɪˈdjuːs/
15. **carbon footprint** : (n.p) lượng khí thải carbon /ˌkɑːbən ˈfʊtprɪnt/
16. **protect** : (v) bảo vệ /prəˈtekt/
</vocabulary>

<!-- chunk: dialogue -->
<teacher_script pause="0">
Giờ nghe và đọc hội thoại giữa Mike và Nam nha. Bài 1 trang 18.
</teacher_script>
...
Bài 2 <eng>Read the conversation again and answer the following questions</eng>. Đọc lại hội thoại rồi trả lời câu hỏi nha. 1 phút.
</teacher_script>

<task>
**Đề:** Read the conversation again and answer the following questions.
**Dịch đề:** Đọc lại bài hội thoại và trả lời các câu hỏi sau.
</task>
...
<explanation>
**1.** Nam nói: "It was set up by the Youth Union in my school." => Đoàn Thanh niên trường thành lập.

**2.** Nam nói: "Its aim is to improve our environment and encourage people to adopt a greener lifestyle." => Cải thiện môi trường và khuyến khích sống xanh.

**3.** Nam nói: "I think we'll organise more activities to raise local people's awareness of environmental issues." => Tổ chức hoạt động nâng cao nhận thức về vấn đề môi trường.
</explanation>

<!-- chunk: exercise_3 -->
### Bài 3 trang 19 - Matching

<teacher_script pause="60">
Bài 3 <eng>Match the verbs or phrasal verbs in A with suitable nouns or noun phrases in B</eng>. Nối động từ với danh từ phù hợp nha. 1 phút.
</teacher_script>

<task>
**Đề:** Match the verbs or phrasal verbs in A with suitable nouns or noun phrases in B.
**Dịch đề:** Nối các động từ hoặc cụm động từ trong cột A với danh từ phù hợp trong cột B.
</task>

<questions type="matching">
**A:** 1. raise | 2. reduce | 3. clean up | 4. adopt | 5. set up
...
**4-b:** adopt a greener lifestyle - sống theo lối sống xanh hơn
**5-a:** set up a club - thành lập câu lạc bộ

Các em nhớ các cụm từ này nha, rất quan trọng cho chủ đề môi trường!
</explanation>

<!-- chunk: exercise_4 -->
### Bài 4 trang 19 - Fill Blanks

<teacher_script pause="45">
Bài 4 <eng>Complete the following sentences based on the conversation</eng>. Hoàn thành câu dựa trên hội thoại nha. 45 giây.
</teacher_script>

<task>
**Đề:** Complete the following sentences based on the conversation in 1.
**Dịch đề:** Hoàn thành các câu dựa trên đoạn hội thoại ở bài 1.
</task>
...
<answer>
**Đáp án:** 1. was set up | 2. are going to | 3. will
</answer>

<explanation>
**1. was set up** - Câu bị động thì quá khứ đơn: The club WAS SET UP by... (Câu lạc bộ được thành lập bởi...)

**2. are going to** - Dùng <eng>be going to</eng> vì đây là kế hoạch đã được lên trước: "We're going to clean up the school."

**3. will** - Dùng <eng>will</eng> vì đây là dự đoán: "I think we will organise..." Nam nghĩ rằng họ sẽ tổ chức.

Đây là mở đầu cho ngữ pháp bài này: <eng>will</eng> vs <eng>be going to</eng> và câu bị động <eng>passive voice</eng>.
</explanation>

<!-- chunk: end -->
<teacher_script pause="0">
Bài <eng>Getting Started</eng> Unit 2 xong rồi nha. Các em đã biết thêm nhiều từ vựng về môi trường. Nhớ ôn bài hen!
</teacher_script>
