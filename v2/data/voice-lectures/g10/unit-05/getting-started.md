...
Ok lớp 10, hôm nay mình học bài <eng>Getting Started</eng> Unit 5: <eng>Inventions</eng> nha. Bài này nói về các phát minh cho giáo dục. Mở sách trang 52 đi.
</teacher_script>
...
<vocabulary>
1. **invention** : (n) phát minh /ɪnˈvenʃn/
2. **laptop** : (n) máy tính xách tay /ˈlæptɒp/
3. **smartphone** : (n) điện thoại thông minh /ˈsmɑːtfəʊn/
4. **useful** : (adj) hữu ích /ˈjuːsfl/
5. **allow someone to do something** : (v.p) cho phép ai làm gì /əˈlaʊ/
6. **completely** : (adv) hoàn toàn /kəmˈpliːtli/
7. **suitable** : (adj) phù hợp /ˈsuːtəbl/
8. **educational apps** : (n.p) ứng dụng giáo dục /ˌedjuˈkeɪʃənl æps/
9. **convenient** : (adj) thuận tiện /kənˈviːniənt/
10. **communicate** : (v) giao tiếp /kəˈmjuːnɪkeɪt/
11. **valuable** : (adj) có giá trị /ˈvæljuəbl/
</vocabulary>

<!-- chunk: dialogue -->
<teacher_script pause="0">
Giờ nghe và đọc hội thoại nha. Phong và bố đang bàn về việc mua gì cho việc học.
</teacher_script>
...
<!-- chunk: exercise_2 -->
### Bài 2 trang 53 - Comprehension

<teacher_script pause="60">
Bài 2: Đọc lại hội thoại rồi trả lời câu hỏi nha. 1 phút.
</teacher_script>
...
*Phong và bố nói về những phát minh nào?*

**2.** How useful are laptops?
*Laptop hữu ích như thế nào?*
...
2. Laptops have allowed us to study better and work faster. They've completely changed our lives.
3. The apps allow students to communicate and learn at the same time.
</answer>

<!-- chunk: exercise_3 -->
### Bài 3 trang 53 - Nouns and Adjectives

<teacher_script pause="45">
Bài 3: Tìm 3 danh từ và 3 tính từ trong hội thoại để nói về phát minh nha. 45 giây.
</teacher_script>

<task>
**Đề:** Find three nouns and three adjectives in the conversation to talk about inventions.
**Dịch đề:** Tìm 3 danh từ và 3 tính từ trong hội thoại để nói về phát minh.
</task>

<questions type="fill_blanks">
**Adjectives:** 1. useful | 2. ________ | 3. ________
...
<answer>
**Đáp án:**
Adjectives: 1. useful | 2. suitable | 3. valuable
Nouns: 4. laptop | 5. smartphone | 6. apps
</answer>

<!-- chunk: exercise_4 -->
### Bài 4 trang 53 - Fill in the blanks

<teacher_script pause="60">
Bài 4: Điền từ vào bản tóm tắt hội thoại nha. 1 phút.
</teacher_script>

<task>
**Đề:** Fill in each gap in the summary of the conversation with ONE word from 1.
**Dịch đề:** Điền vào mỗi chỗ trống trong bản tóm tắt hội thoại bằng MỘT từ.
</task>
...
<answer>
**Đáp án:** 1. for | 2. have | 3. improved | 4. to | 5. to | 6. learn
</answer>

<explanation>
**1. for** - "for a long time" (trong một thời gian dài) - dấu hiệu thì hiện tại hoàn thành.
**2. have** - "have completely changed" - thì hiện tại hoàn thành.
**3. improved** - "have also improved" - thì hiện tại hoàn thành, cải thiện.
**4. to** - "it's fun to study" - cấu trúc It's + adj + to V.
**5. to, 6. learn** - "allow students to learn" - cấu trúc allow + O + to V.
</explanation>

<!-- chunk: end -->
<teacher_script pause="0">
Bài <eng>Getting Started</eng> Unit 5 xong rồi nha. Nhớ từ vựng: <eng>invention, useful, suitable, valuable, convenient, allow, communicate</eng>. Và nhớ cấu trúc: <eng>allow someone to do something</eng>. Ôn bài hen!
</teacher_script>
