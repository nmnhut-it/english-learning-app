...
## GETTING STARTED - Volunteering in a Community

<!-- chunk: intro -->
<teacher_script pause="0">
Ok lớp 10, hôm nay mình học bài <eng>Getting Started</eng> Unit 4: <eng>For a Better Community</eng> nha. Bài này nói về công tác tình nguyện trong cộng đồng. Mở sách trang 40 đi.
</teacher_script>
...
<vocabulary>
1. **volunteer** : (n) tình nguyện viên /ˌvɒlənˈtɪə(r)/
2. **community development** : (n.p) phát triển cộng đồng /kəˈmjuːnəti dɪˈveləpmənt/
3. **advertisement** : (n) quảng cáo /ədˈvɜːtɪsmənt/
4. **application** : (n) đơn ứng tuyển /ˌæplɪˈkeɪʃn/
5. **community service** : (n.p) dịch vụ cộng đồng /kəˈmjuːnəti ˈsɜːvɪs/
6. **boost** : (v) thúc đẩy /buːst/
7. **confidence** : (n) sự tự tin /ˈkɒnfɪdəns/
8. **orphanage** : (n) trại trẻ mồ côi /ˈɔːfənɪdʒ/
9. **get involved** : (v.p) tham gia /ɡet ɪnˈvɒlvd/
10. **fill in** : (phr.v) điền vào /fɪl ɪn/
</vocabulary>

<!-- chunk: dialogue -->
<teacher_script pause="0">
Giờ nghe và đọc hội thoại nha.
</teacher_script>
...
<!-- chunk: exercise_2 -->
### Bài 2 trang 41 - Comprehension

<teacher_script pause="60">
Bài 2: Trả lời câu hỏi nha. 1 phút.
</teacher_script>
...
**1.** Where does Tam work as a volunteer?
**2.** How did Tam become a volunteer?
...
<answer>
**Đáp án:**
1. At the local centre for community development.
2. He saw an advertisement for volunteers at the centre, applied, and his application was successful.
3. Community service benefits the local area, boosts confidence, and helps learn many useful skills.
</answer>

<!-- chunk: exercise_3 -->
### Bài 3 trang 41 - Grammar Introduction

<teacher_script pause="45">
Bài 3: Hoàn thành câu dựa trên hội thoại nha. 45 giây.
</teacher_script>

<task>
**Đề:** Complete the sentences based on the conversation.
**Dịch đề:** Hoàn thành câu dựa trên hội thoại.
</task>

<questions type="fill_blanks">
**1.** When Kim came, Tam ________ (work) as a volunteer.
...
<answer>
**Đáp án:** 1. was working | 2. was visiting
</answer>

<explanation>
Cả 2 câu đều dùng thì quá khứ tiếp diễn <eng>Past Continuous</eng>: was/were + V-ing.
**1.** Khi Kim đến (quá khứ đơn), Tâm ĐANG LÀM (quá khứ tiếp diễn).
**2.** Trong khi Tâm ĐANG THĂM (quá khứ tiếp diễn), anh ấy thấy quảng cáo (quá khứ đơn).

Đây là mở đầu cho ngữ pháp: <eng>Past Continuous</eng> - thì quá khứ tiếp diễn.
</explanation>

<!-- chunk: end -->
<teacher_script pause="0">
Bài <eng>Getting Started</eng> Unit 4 xong rồi nha. Nhớ từ vựng về tình nguyện: <eng>volunteer, community, orphanage, application</eng>. Ôn bài hen!
</teacher_script>
