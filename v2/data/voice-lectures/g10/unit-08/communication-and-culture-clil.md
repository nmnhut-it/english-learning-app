...
## COMMUNICATION AND CULTURE - Giving Instructions & Digital Learning
...
<teacher_script pause="0">
Phần <eng>Everyday English</eng>: <eng>Giving instructions</eng> - cách hướng dẫn ai đó làm gì.
</teacher_script>

<audio>
https://img.loigiaihay.com/picture/2022/0808/062.mp3
</audio>
...
<task>
**Đề:** Listen and complete the conversation with the words in the box: go, wait, click, type.
**Dịch đề:** Nghe và hoàn thành hội thoại.
</task>

<questions type="fill_blanks">
**Tom:** Mai, can you show me how to install the app I-Speak on my smartphone?
**Mai:** Of course. First, (1) _______ to the App store on your phone. Second, (2) _______ 'I-Speak' in the search box, then (3) _______ the 'Search' button.
...
<answer>
**Đáp án:** 1. go | 2. type | 3. click | 4. wait
</answer>

<grammar>
**Cách hướng dẫn (Giving instructions):**
- **First,** go to... (Đầu tiên, vào...)
- **Second,** type... (Thứ hai, gõ...)
- **Then,** click... (Sau đó, nhấn...)
- **Now,** wait until... (Bây giờ, đợi cho đến khi...)
- **Next,** ... (Tiếp theo, ...)
- **Finally,** ... (Cuối cùng, ...)

Dùng dạng mệnh lệnh (imperative): động từ nguyên mẫu đứng đầu câu.
</grammar>

<!-- chunk: everyday_english_2 -->
### Everyday English - Bài 2 trang 93

<teacher_script pause="0" action="record">
Bài 2, thực hành hướng dẫn bạn cài đặt một ứng dụng khác. Dùng <eng>First, Second, Then, Finally</eng>. Ghi âm nha.
</teacher_script>

<task>
**Đề:** Work in pairs. Make similar conversations about how to install another app.
