...
Ok lớp 10, hôm nay mình học Unit 10: <eng>Ecotourism</eng> - Du lịch sinh thái nha. Bài <eng>Getting Started</eng> về chuyến dã ngoại thân thiện với môi trường đến Động Phong Nha. Mở sách ra đi.
</teacher_script>
...
<vocabulary>
1. **field trip** : (n) chuyến đi thực tế /fiːld trɪp/
2. **stalactites** : (n) thạch nhũ /ˈstæləktaɪts/
...
<!-- chunk: dialogue -->
### Bài 1 trang 110 - Listen and Read

<teacher_script pause="0">
Bài 1, nghe và đọc hội thoại giữa cô Hoa và học sinh về chuyến dã ngoại đến Động Phong Nha nha.
</teacher_script>
...
<!-- chunk: exercise_2 -->
### Bài 2 trang 110 - Find and Correct Mistakes

<teacher_script pause="45">
Bài 2, đọc lại hội thoại rồi tìm và sửa lỗi sai trong mỗi câu nha. 45 giây.
</teacher_script>

<task>
**Đề:** Read the conversation again. Then find and correct a mistake in each sentence below.
**Dịch đề:** Đọc lại hội thoại. Sau đó tìm và sửa lỗi sai trong mỗi câu.
</task>

<questions type="complete_sentences">
**1.** On an eco-friendly fieldtrip, tourists enjoy, explore and damage the environment.
*Trong chuyến dã ngoại thân thiện với môi trường, du khách tận hưởng, khám phá và phá hoại môi trường.*

**2.** Nam will take pieces of stalactites because they take a long time to form.
*Nam sẽ lấy các mảnh thạch nhũ vì chúng mất nhiều thời gian để hình thành.*
...
2. will take → won't take
3. a lot of → less
</answer>

<explanation>
**Câu 1:** Sai từ "damage". Sửa thành "do not damage". Cô Hoa nói: chúng ta tận hưởng, khám phá nhưng KHÔNG phá hoại.
**Câu 2:** Sai "will take". Sửa thành "won't take". Nam hứa sẽ KHÔNG chạm vào thạch nhũ.
**Câu 3:** Sai "a lot of". Sửa thành "less". Mai nói sẽ mang đồ ăn vặt với ÍT bao bì hơn.
</explanation>

<!-- chunk: exercise_3 -->
### Bài 3 trang 110 - Dos and Don'ts

<teacher_script pause="30">
Bài 3, phân loại các cụm từ vào cột "Nên làm" và "Không nên làm" nha. 30 giây.
</teacher_script>

<task>
**Đề:** Put each phrase into the correct column.
**Dịch đề:** Đặt mỗi cụm từ vào cột đúng.
</task>

<questions type="matching">
**Phrases:** explore the place | damage the environment | leave litter behind | learn about the place
...
<explanation>
**Nên làm:** khám phá địa điểm, tìm hiểu về địa điểm → hoạt động tích cực, không gây hại.
**Không nên làm:** phá hoại môi trường, bỏ lại rác → hoạt động tiêu cực, gây hại cho môi trường.
</explanation>

<!-- chunk: exercise_4 -->
### Bài 4 trang 110 - Complete Sentences

<teacher_script pause="30">
Bài 4, hoàn thành các câu từ bài 1 nha. Chú ý câu điều kiện. 30 giây.
</teacher_script>

<task>
**Đề:** Complete these sentences from 1.
**Dịch đề:** Hoàn thành các câu từ bài 1.
</task>
...
<explanation>
**Câu 1:** Câu điều kiện loại 1 - If + hiện tại đơn, will + V. "If I **add** some... it **will be** the best." → Tình huống có thể xảy ra.
**Câu 2:** Câu điều kiện loại 2 - If + quá khứ đơn, would + V. "If I **were** you, I **wouldn't** bring." → Tình huống giả định, không thật (cô không phải là em).
</explanation>

<grammar>
**Câu điều kiện loại 1 (Type 1):** Tình huống có thể xảy ra
- If + S + V (hiện tại đơn), S + will + V
- VD: If I add some, it will be the best.

**Câu điều kiện loại 2 (Type 2):** Tình huống giả định, không thật
- If + S + V (quá khứ đơn), S + would + V
- VD: If I were you, I wouldn't bring too many snacks.
</grammar>

<!-- chunk: end -->
<teacher_script pause="0">
Ok bài <eng>Getting Started</eng> Unit 10 xong rồi nha. Nhớ: du lịch sinh thái nghĩa là tận hưởng, khám phá nhưng KHÔNG phá hoại môi trường. Và câu điều kiện loại 1 (có thể xảy ra) và loại 2 (giả định). Ôn bài hen!
</teacher_script>
