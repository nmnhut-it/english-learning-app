...
Các em mở sách ra, Unit 8, bài <eng>A Closer Look 2</eng>, ghi tựa bài. Sau đó bấm nút "Bắt đầu" bên dưới để học từ vựng. Máy sẽ đọc và các em đọc theo. Sau đó các em làm bài trắc nghiệm từ vựng rồi ghi từ vựng vô tập.
</teacher_script>

<vocabulary>
1. **chew** : (v) nhai /tʃuː/
2. **swallow** : (v) nuốt /ˈswɒləʊ/
3. **park** : (v) đỗ xe /pɑːk/
4. **lift** : (n) thang máy /lɪft/
5. **fire** : (n) đám cháy, hỏa hoạn /ˈfaɪə(r)/
6. **tidy** : (v) dọn dẹp /ˈtaɪdi/
</vocabulary>
...
|----------|-----------|-------|
| **Khẳng định** | S + V-ed/V2 | I **played** football yesterday. |
| **Phủ định** | S + didn't + V0 | I **didn't play** football yesterday. |
| **Nghi vấn** | Did + S + V0? | **Did** you **play** football yesterday? |

### 3. Cấu trúc với động từ TO BE
...
**Yêu cầu:** Chia động từ đúng thì quá khứ đơn.
</task>
...
*Bố tôi chơi rất nhiều quần vợt cách đây vài năm.*
...
*Tôi ở phòng tập Chủ nhật tuần trước, nhưng tôi không thấy bạn ở đó.*
...
| # | Đáp án | Lý do |
|---|--------|-------|
| 1 | **C. was** | "There + was" vì "an interesting match" là số ít. Dấu hiệu: "last night" |
| 2 | **B. played** | Dấu hiệu: "some years ago" → quá khứ đơn, chia V-ed |
| 3 | **C. didn't see** | Câu phủ định quá khứ: didn't + V0 (see) |
| 4 | **A. didn't ask** | Dấu hiệu: "this morning" (đã qua). Phủ định: didn't + ask |
| 5 | **B. Did you** | Câu hỏi quá khứ: Did + S + V0? Dấu hiệu: "last night" |

**Lỗi hay gặp:**
- ❌ "not saw" → Sai! Phải dùng "didn't see"
- ❌ "Were you sleep" → Sai! Động từ "sleep" không dùng với "were"
...
<task>
**Đề:** Write the correct form of the verbs to complete the conversation.
**Dịch đề:** Viết dạng đúng của động từ để hoàn thành bài hội thoại.
...
| # | Động từ gốc | Quá khứ | Loại |
|---|-------------|---------|------|
| 1 | go | **went** | Bất quy tắc: go-went-gone |
| 2 | have | **had** | Bất quy tắc: have-had-had |
| 3 | do | **did...do** | Câu hỏi: What + did + S + do? |
| 4 | visit | **visited** | Quy tắc (+ed) |
| 5 | eat | **ate** /eɪt/ | Bất quy tắc: eat-ate-eaten |
...
<task>
**Đề:** Work in groups. Ask and answer questions about last weekend.
**Dịch đề:** Làm việc theo nhóm. Hỏi và trả lời câu hỏi về cuối tuần trước.
**Yêu cầu:** Dùng thì quá khứ đơn để hỏi đáp.
</task>
...
|------|-----------|-------|
| **Khẳng định** | V (nguyên mẫu)! | **Sit** down! (Ngồi xuống!) |
| **Phủ định** | Don't + V! | **Don't sit** there! (Đừng ngồi đó!) |

### Đặc điểm:
- Không có chủ ngữ (ngầm hiểu là "you")
- Động từ ở dạng nguyên mẫu
- Dùng để: ra lệnh, khuyên bảo, hướng dẫn, cấm
...
<task>
**Đề:** Look at each picture and choose the correct answer.
**Dịch đề:** Nhìn mỗi bức tranh và chọn đáp án đúng.
**Yêu cầu:** Chọn câu mệnh lệnh phù hợp với từng tình huống.
</task>

<questions type="multiple_choice">
**1.** (Park / Don't park) here.

*Tranh: Biển cấm đỗ xe*

**2.** (Close / Open) the window. It's windy outside.

*Tranh: Cửa sổ mở, gió thổi mạnh*
...
*Tranh: Thang máy với biển báo cháy*

**5.** (Try / Don't try) to get up early to do some exercise.

*Tranh: Người tập thể dục buổi sáng*
</questions>
...
| # | Đáp án | Tình huống | Lý do |
|---|--------|------------|-------|
| 1 | **Don't park** | Biển cấm đỗ xe | Cấm = Don't |
| 2 | **Close** | Gió thổi mạnh | Cần đóng cửa lại |
| 3 | **Tidy up** | Phòng bừa bộn | Cần dọn dẹp |
| 4 | **Don't use** | Có cháy | Nguy hiểm, không được dùng thang máy |
...
<task>
**Đề:** Tell your friends what to do and what not to do at the gym.
**Dịch đề:** Nói với bạn điều nên làm và không nên làm ở phòng tập.
**Yêu cầu:** Viết các câu mệnh lệnh về quy định phòng gym.
</task>
