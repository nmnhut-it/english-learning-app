...
3. **racket** : (n) vợt (cầu lông, tennis) /ˈrækɪt/
4. **goggles** : (n) kính bơi /ˈɡɒɡlz/
5. **sports shoes** : (n) giày thể thao /spɔːts ʃuːz/
6. **bicycle** : (n) xe đạp /ˈbaɪsɪkl/
7. **boating** : (n) môn chèo thuyền /ˈbəʊtɪŋ/
8. **cycling** : (n) môn đạp xe /ˈsaɪklɪŋ/
9. **ball games** : (n) các môn có bóng /bɔːl ɡeɪmz/
10. **badminton** : (n) cầu lông /ˈbædmɪntən/
11. **champion** : (n) nhà vô địch /ˈtʃæmpiən/
12. **competition** : (n) cuộc thi đấu /ˌkɒmpəˈtɪʃn/
13. **sporty** : (adj) thể thao, năng động /ˈspɔːti/
14. **marathon** : (n) chạy marathon /ˈmærəθən/
15. **congratulations** : (interj) xin chúc mừng /kənˌɡrætʃʊˈleɪʃnz/
</vocabulary>
...
<task>
**Đề:** Write the right words under the pictures.
**Dịch đề:** Viết từ đúng dưới các bức tranh.
**Yêu cầu:** Nhìn tranh dụng cụ thể thao, chọn từ phù hợp.
</task>

<questions type="matching">
**Word bank:** *ball / boat / racket / goggles / sports shoes*

| Tranh | Dụng cụ |
|-------|---------|
| 1. (quả bóng tròn) | _______ |
| 2. (đôi giày thể thao) | _______ |
| 3. (chiếc thuyền) | _______ |
| 4. (cây vợt cầu lông) | _______ |
| 5. (kính bơi) | _______ |
</questions>
...
| # | Tranh | Đáp án | Nghĩa |
|---|-------|--------|-------|
| 1 | Quả bóng tròn | **ball** | quả bóng |
| 2 | Đôi giày | **sports shoes** | giày thể thao |
...
<task>
**Đề:** What sports are these things for? Match each thing in column A with a sport in column B.
**Dịch đề:** Những dụng cụ này dành cho môn thể thao nào? Nối dụng cụ ở cột A với môn thể thao ở cột B.
**Yêu cầu:** Hiểu dụng cụ nào dùng cho môn nào.
</task>

<questions type="matching">
| | Column A (Dụng cụ) | | Column B (Môn thể thao) |
|---|-------------------|---|------------------------|
| 1 | bicycle | a | boating |
| 2 | ball | b | swimming |
| 3 | boat | c | cycling |
...
| Nối | Dụng cụ | Môn thể thao | Lý do |
|-----|---------|--------------|-------|
| 1-c | bicycle | cycling | Xe đạp → đạp xe |
| 2-d | ball | ball games | Bóng → các môn có bóng |
| 3-a | boat | boating | Thuyền → chèo thuyền |
| 4-b | goggles | swimming | Kính bơi → bơi lội |
| 5-e | racket | badminton | Vợt → cầu lông |

**Mẹo nhớ:** Từ dụng cụ thường tạo thành tên môn thể thao bằng cách thêm -ing:
- boat → boat**ing**
- cycle → cycl**ing**
- swim → swimm**ing**
- run → runn**ing**
...
<task>
**Đề:** Fill each blank with one of the words from the box.
**Dịch đề:** Điền vào chỗ trống với một trong các từ trong khung.
**Yêu cầu:** Đọc câu, chọn từ phù hợp về nghĩa.
</task>

<questions type="fill_blanks">
**Word bank:** *sporty / champion / competition / marathon / congratulations*

**1.** She won an international sports _______.

*Cô ấy đã thắng một cuộc thi thể thao quốc tế.*
...
*"Bạn có thể gửi lời chúc mừng của tôi đến người thắng cuộc không?"*

**4.** My friend David is very _______. He does exercise every day.

*Bạn David của tôi rất năng động. Cậu ấy tập thể dục mỗi ngày.*
...
| # | Từ | Tại sao |
|---|-----|---------|
| 1 | **competition** | "won" + "international sports ___" = cuộc thi |
| 2 | **champion** | "became the world tennis ___" = nhà vô địch |
| 3 | **congratulations** | "send my ___ to the winner" = lời chúc mừng |
| 4 | **sporty** | "does exercise every day" = năng động, thể thao |
| 5 | **marathon** | "took place in 1896" = cuộc đua marathon đầu tiên |
...
## Âm /e/ và /æ/ - Cách phát âm

### Vị trí miệng và lưỡi

| Âm | Miệng | Lưỡi | Như âm |
|----|-------|------|--------|
| **/e/** | Mở hơi hẹp | Hơi cao | Như "e" trong "bé" |
| **/æ/** | Mở rộng hơn | Thấp hơn, đẩy ra trước | Giữa "e" và "a" |

### Mẹo phân biệt:
- **/e/**: Miệng hẹp, ngắn gọn → "e" ngắn
- **/æ/**: Miệng rộng, dài hơn → "a" mở

### Quy tắc nhận biết:
| Âm | Thường viết | Ví dụ |
|----|-------------|-------|
| /e/ | e, ea | t**e**nnis, ch**e**ss, **e**xercise |
...
<task>
**Đề:** Listen and repeat. Pay attention to the sounds /e/ and /æ/.
**Dịch đề:** Nghe và lặp lại. Chú ý đến âm /e/ và /æ/.
**Yêu cầu:** Nghe audio, đọc theo, phân biệt 2 âm.
</task>

<audio src="https://img.loigiaihay.com/picture/2021/1104/u8-look1-ex4.mp3">
**Audio:** Pronunciation /e/ and /æ/
</audio>

<questions type="pronunciation">
| /e/ (miệng hẹp) | Nghĩa | /æ/ (miệng rộng) | Nghĩa |
|-----------------|-------|------------------|-------|
| **chess** /tʃes/ | cờ vua | **racket** /ˈrækɪt/ | cây vợt |
| **tennis** /ˈtenɪs/ | quần vợt | **match** /mætʃ/ | trận đấu |
| **exercise** /ˈeksəsaɪz/ | bài tập | **marathon** /ˈmærəθən/ | marathon |
...
<task>
**Đề:** Listen and repeat. Underline the words having the sounds /e/ and /æ/.
**Dịch đề:** Nghe và lặp lại. Gạch dưới các từ có chứa âm /e/ và /æ/.
**Yêu cầu:** Tìm từ có /e/ và /æ/ trong mỗi câu.
</task>

<audio src="https://img.loigiaihay.com/picture/2021/1104/u8-look1-ex5-1.mp3">
**Audio:** Exercise 5 - Listen and underline
</audio>
...
**1.** They c**a**nnot take part in this cont**e**st.
- cannot → /æ/ | contest → /e/

**2.** They beg**a**n the m**a**tch v**e**ry late.
- began, match → /æ/ | very → /e/

**3.** Please g**e**t the r**a**cket for me.
- get → /e/ | racket → /æ/

**4.** We play ch**e**ss **e**very S**a**turday.
- chess, every → /e/ | Saturday → /æ/

**5.** My gr**a**ndpa is old, but he's **a**ctive.
- grandpa, active → /æ/
</explanation>
