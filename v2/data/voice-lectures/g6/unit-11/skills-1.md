...
## SKILLS 1 - Reading & Speaking: Making Our School Greener
...
<vocabulary>
1. **tip** : (n) mẹo, lời khuyên /tɪp/
2. **recycling bin** : (n) thùng tái chế /riːˈsaɪklɪŋ bɪn/
3. **put recycling bins** : đặt thùng tái chế /pʊt riːˈsaɪklɪŋ bɪnz/
4. **exchange** : (v) trao đổi /ɪksˈtʃeɪndʒ/
5. **charity** : (n) tổ chức từ thiện /ˈtʃærəti/
6. **give to charity** : tặng cho tổ chức từ thiện /ɡɪv tə ˈtʃærəti/
...
Bài 2 trang 54. Nối từ với nghĩa đúng. 1 phút nha.
</teacher_script>

<task>
**Đề:** Match the words/phrases with their meanings (a–e).
**Dịch đề:** Nối từ/cụm từ với nghĩa của chúng (a–e).
</task>
...
Bài 4 trang 54. Nhìn vào 6 mẹo của Nam — sắp xếp từ dễ nhất đến khó nhất theo ý kiến của nhóm. Thảo luận với nhóm nha. 2 phút.
</teacher_script>
...
*(Trao đổi sách và đồng phục cũ với bạn bè hoặc tặng từ thiện.)*
...
*(Mang chai nước tái sử dụng đến trường.)*

e. Planting trees at school.
*(Trồng cây ở trường.)*

f. Finding creative ways to reuse old items before throwing them away.
*(Tìm cách sáng tạo để tái sử dụng đồ cũ trước khi vứt đi.)*
</questions>

<teacher_script pause="0">
Gợi ý sắp xếp nha — nhưng không có đáp án duy nhất đúng, tùy quan điểm của nhóm.
</teacher_script>
...
<!-- chunk: speaking-5 -->
<teacher_script pause="120">
Bài 5 trang 54. Mẹo *f* nói tìm cách sáng tạo để tái sử dụng đồ cũ. Các em nghĩ có thể tái sử dụng những thứ này như thế nào? Thảo luận với nhóm — 2 phút.
</teacher_script>
...
**a.** Used gift wrap *(giấy gói quà đã dùng)*
**b.** Used water bottles *(chai nước đã dùng)*
...
Bây giờ nói về ý kiến của em — chọn 1 trong 3 đồ vật trên và giải thích cách tái sử dụng nha. Bấm nút ghi âm đi.
</teacher_script>
