...
<task>
**Đề:** Match the following adjectives with their meanings.
**Dịch đề:** Nối các tính từ sau với nghĩa của chúng.
</task>
...
<explanation>
**Giải thích:**
1. **shocking**: hard to believe (khó tin) -> gây sốc.
2. **dull**: fell asleep (ngủ gật) -> chán ngắt.
3. **enjoyable**: you will enjoy (bạn sẽ thích) -> thú vị.
4. **violent**: too many fights (quá nhiều đánh nhau) -> bạo lực.
...
**1. Âm /ɪə/** (như trong từ *ear*):
- Kết hợp âm /ɪ/ và /ə/.
- Ví dụ: ear, here, near, idea.

**2. Âm /eə/** (như trong từ *air*):
- Kết hợp âm /e/ và /ə/.
- Ví dụ: air, chair, there, square.
</pronunciation_theory>
