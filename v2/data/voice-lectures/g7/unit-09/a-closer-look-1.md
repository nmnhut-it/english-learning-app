...
- <eng>Halloween</eng> có <eng>pumpkins</eng> (bí ngô) - khắc bí ngô thành đèn lồng ma
- <eng>Mid-Autumn Festival</eng> của mình có <eng>lion dance</eng> (múa lân) và <eng>moon cakes</eng> (bánh trung thu)
</teacher_script>
...
<task>
**Đề:** Write under each picture a festival name from the box.
**Dịch đề:** Viết tên các lễ hội trong hộp vào dưới mỗi bức tranh tương ứng.
</task>
...
<task>
**Đề:** Complete the table below with the phrases from the box.
**Dịch đề:** Hoàn thành bảng dưới đây với các cụm từ trong hộp.
</task>
...
|----------|------|----------|
| Easter | _______ | _______ |
| Halloween | _______ | _______ |
| Mid-Autumn Festival | _______ | _______ |
...
**Từ để điền:**
| painting eggs | Christmas | Mid-Autumn Festival | candy apples | Cannes Film Festival | turkey |

1. At _______, people give gifts to each other.
   *(Vào _______, mọi người tặng quà cho nhau.)*

2. My children love _______ at Easter.
   *(Các con tôi thích _______ vào lễ Phục sinh.)*

3. How many _______ do you need for the Halloween party?
   *(Bạn cần bao nhiêu _______ cho bữa tiệc Halloween?)*

4. At the _______, there are many interesting films.
   *(Tại _______, có rất nhiều bộ phim hấp dẫn.)*

5. Performing lion dances is one of the activities at the _______.
   *(Biểu diễn múa lân là một trong những hoạt động vào dịp _______)*
...
Ví dụ: <eng>'costume</eng> (danh từ) nhấn âm 1, nhưng <eng>en'joy</eng> (động từ) nhấn âm 2.
</teacher_script>

<grammar>
**Stress in two-syllable words (Trọng âm của từ 2 âm tiết)**

**1. Danh từ và Tính từ → Nhấn âm tiết THỨ NHẤT**
- 'costume /ˈkɒstjuːm/ - trang phục
- 'fireworks /ˈfaɪəwɜːks/ - pháo hoa
- 'turkey /ˈtɜːki/ - gà tây
- 'happy /ˈhæpi/ - hạnh phúc

**2. Động từ → Nhấn âm tiết THỨ HAI**
- en'joy /ɪnˈdʒɔɪ/ - tận hưởng
- de'cide /dɪˈsaɪd/ - quyết định
- dis'cuss /dɪˈskʌs/ - thảo luận
...
<audio src="https://img.loigiaihay.com/picture/2022/0815/062.mp3">
**Audio:** Exercise 4
</audio>

<task>
**Đề:** Listen and repeat. Then underline the stressed syllable in each word.
**Dịch đề:** Lắng nghe và nhắc lại. Sau đó gạch chân âm tiết được nhấn trọng âm trong mỗi từ.
</task>
...
| Nouns and Adjectives | Verbs |
|----------------------|-------|
| **'cos**tume (n) - trang phục | en**'joy** (v) - tận hưởng |
| **'fire**works (n) - pháo hoa | de**'cide** (v) - quyết định |
| **'tur**key (n) - gà tây | dis**'cuss** (v) - thảo luận |
| **'hap**py (adj) - hạnh phúc | pre**'pare** (v) - chuẩn bị |

**Giải thích:**
- Danh từ/tính từ (costume, fireworks, turkey, happy) → nhấn âm ĐẦU
- Động từ (enjoy, decide, discuss, prepare) → nhấn âm SAU
</answer>
...
<audio src="https://img.loigiaihay.com/picture/2022/0815/063.mp3">
**Audio:** Exercise 5
</audio>

<task>
**Đề:** Listen and repeat the sentences. Underline the stressed syllables in the bold words.
**Dịch đề:** Nghe và nhắc lại các câu. Gạch chân các âm tiết được nhấn mạnh trong các từ in đậm.
</task>

<questions type="fill_blanks">
1. We're going to **attend** an Easter **party** at Nick's house.
   *(Chúng mình sẽ tham dự một bữa tiệc Phục sinh tại nhà Nick.)*
...
4. Did you go to the Da Lat **Flower** Festival with your **parents**?
   *(Bạn có đi Festival Hoa Đà Lạt với bố mẹ không?)*
...
2. The **'dan**cers will per**'form** traditional dances at the festival.
   - **dancers** (danh từ) → nhấn âm 1: 'DAN-cers
   - **perform** (động từ) → nhấn âm 2: per'FORM

3. At **'Christ**mas, people usually buy **'pre**sents for their family.
   - **Christmas** (danh từ) → nhấn âm 1: 'CHRIST-mas
   - **presents** (danh từ) → nhấn âm 1: 'PRE-sents

4. Did you go to the Da Lat **'Flow**er Festival with your **'par**ents?
   - **Flower** (danh từ) → nhấn âm 1: 'FLOW-er
   - **parents** (danh từ) → nhấn âm 1: 'PAR-ents

5. My aunt is **'cle**ver and **'pa**tient.
...
- Quy tắc trọng âm: Danh từ/tính từ nhấn âm ĐẦU, Động từ nhấn âm SAU

Bài sau học <eng>A Closer Look 2</eng> về ngữ pháp nha. Bye!
</teacher_script>
