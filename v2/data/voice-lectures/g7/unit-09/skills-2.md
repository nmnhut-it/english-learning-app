...
2. **Turkey Day** : (n) Ngày Gà Tây (tên khác của Thanksgiving)
3. **national holiday** : (n) ngày lễ quốc gia /ˈnæʃnəl ˈhɒlɪdeɪ/
4. **harvest** : (n) mùa thu hoạch /ˈhɑːvɪst/
5. **thankful** : (adj) biết ơn /ˈθæŋkfl/
6. **feast** : (n) bữa tiệc lớn /fiːst/
7. **turkey** : (n) gà tây /ˈtɜːki/
8. **sweet potatoes** : (n) khoai lang /swiːt pəˈteɪtəʊz/
9. **cornbread** : (n) bánh mì ngô /ˈkɔːnbred/
10. **board games** : (n) trò chơi cờ bàn /bɔːd ɡeɪmz/
11. **volunteer** : (v) tình nguyện /ˌvɒlənˈtɪə/
12. **homeless** : (adj) vô gia cư /ˈhəʊmləs/
13. **nursing home** : (n) viện dưỡng lão /ˈnɜːsɪŋ həʊm/
</vocabulary>
