...
<grammar>
## Mạo từ A / AN (Indefinite Articles)

### Dùng A / AN khi:
- Danh từ **số ít, chưa xác định** (nhắc đến lần đầu)
- **A** + từ bắt đầu bằng **phụ âm** (b, c, d, f, g, h, k, l, m, n, p, q, r, s, t, v, w, y, z)
- **AN** + từ bắt đầu bằng **nguyên âm** (a, e, i, o, u)

**Ví dụ:**
> a castle (lâu đài) | a kangaroo (chuột túi) | a unique place *(u đọc là /j/ nên dùng a)*
> an island (hòn đảo) | an ancient forest (rừng cổ thụ) | an Englishman (người Anh)

⚠️ **Chú ý:** Dựa vào **âm thanh**, không phải chữ cái:
- **a university** (/juːnɪˈvɜːsɪti/ - bắt đầu bằng /j/) → dùng **a**
...
### Dùng THE khi:
1. **Đã nhắc đến lần trước** (người nghe biết cái nào)
   > I visited a castle. **The** castle was beautiful.

2. **Danh từ duy nhất** trên thế giới
   > **the** sun (mặt trời) | **the** moon (mặt trăng) | **the** sky (bầu trời)

3. **So sánh nhất** (superlative)
   > **the** biggest city | **the** most famous landmark

4. **Tên nước** có chứa từ Kingdom/States/Republic/Union
   > **The** United Kingdom | **The** United States | **The** Republic of Ireland

5. **Đại dương, biển, sông, kênh** (Oceans, Seas, Rivers, Canals)
   > **the** Pacific Ocean | **the** Atlantic Ocean | **the** River Thames | **the** Nile

6. **Dãy núi** (Mountain Ranges) - nhưng KHÔNG dùng với núi đơn lẻ
   > **the** Himalayas | **the** Alps *(dãy núi)*
   > ~~the~~ Mount Everest | ~~the~~ Ben Nevis *(núi đơn lẻ)*

7. **Địa danh nổi tiếng** có chứa common noun (palace, tower, bridge...)
   > **the** Buckingham Palace | **the** Eiffel Tower | **the** Sydney Opera House

8. **Hướng địa lý** dùng làm tên vùng
   > **the** North Pole | **the** South | **the** Middle East
...
### KHÔNG dùng a/an/the với:
- **Tên người:** Mark, Phong, Elizabeth
- **Tên nước thông thường:** Australia, Canada, Scotland *(nhưng có the: the UK, the USA)*
- **Tên thành phố:** London, Sydney, Ottawa
- **Tên núi đơn lẻ:** Mount Everest, Ben Nevis
- **Tên hồ đơn lẻ:** Lake Superior, Loch Ness *(nhưng: the Great Lakes - tên nhóm)*
- **Ngôn ngữ:** English, Vietnamese, French
- **Môn học:** Maths, History, Science
</grammar>
