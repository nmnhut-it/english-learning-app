...
*![](https://img.loigiaihay.com/picture/2023/0420/ex1-reading-u5-ta11-global.png)*
...
Countries have to stop building new coal plants and switch to clean cources of energy. 

*(*Các quốc gia sẽ phải ngừng xây dựng các nhà máy than mới và chuyển sang các nguồn năng lượng sạch*.)*

The last key goal is to **reduce** methane emissions. 

*(Mục tiêu cuối cùng là giảm thiểu lượng khí mê-tan thải ra.)*

Không phải "end" - chấm dứt.
