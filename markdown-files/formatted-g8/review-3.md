# REVIEW 3: UNITS 7-8-9 - ÔN TẬP 3: BÀI 7-8-9
...
- **First syllable stress**: HUmorous, NUmerous, GENerous, NATional, ANimal, TYPical, FEStival, CULtural, POIsonous
- **Second syllable stress**: treMENdous, arRIVal, amBItious

### ✍️ Exercises - Bài tập

#### ✍️ Bài 1a: Listen and repeat, paying attention to the underlined words
...
**Pronunciation notes:**
- sky /skaɪ/ - blue /bluː/
- speaker /ˈspiːkər/ - honesty /ˈɒnəsti/
- store /stɔːr/ - speciality /ˈspeʃəlti/

#### ✍️ Bài 1b: Choose A, B, C, or D to show the word in each group with a different stress pattern
(Chọn A, B, C, hoặc D để chỉ ra từ trong mỗi nhóm có trọng âm khác)
...
#### ✍️ Bài 2: Complete the sentences with the words and phrases from the box
(Hoàn thành các câu với các từ và cụm từ trong khung)

**Box:** customers | bargain | single-use | habitats | natural disasters
...
#### ✍️ Bài 3: Use the correct forms of the words in brackets to complete the sentences
...
2. One (advantage) ______ of shopping online is that you do not know exactly what you will get.
3. Endangered species are animals in the wild that face a high risk of (extinct) ______.
4. (Addict) ______ shopping is a form of behaviour that makes shoppers buy many items they don't need.
5. When a natural disaster happens, we must listen to (instruct) ______ from local authorities.
...
#### ✍️ Bài 4: Use the correct tense of the verbs in brackets to complete the sentences
...
#### ✍️ Bài 5: Complete the sentences, so that they are true for you
...
### 🗣️ Speaking - Nói
#### ✍️ Bài 2: Work in pairs. Take turns to ask your classmate the following question
...
### ✍️ Writing - Viết
#### ✍️ Bài 4: Write a paragraph (80 - 100 words) about where your family shops and give reasons for your choice
(Viết đoạn văn (80 - 100 từ) kể về địa điểm mua sắm của gia đình em và nêu lí do lựa chọn)

**Writing prompt:** My family usually shops _______________________

**Sample answer 1:**
My family usually shops at the supermarket. The supermarket provides a wide range of goods which are displayed under one roof. This helps save a lot of time. If you go to a local market, you have to go to a lot of stores and stalls to buy stuff which is really time consuming and tiring. Another advantage of shopping in supermarket is that you can have more options for the same product for you to choose. For example, there are often one or two fixed brands of soap to choose in a store, but you can see about 10-15 brands of soaps if you go to the supermarket. To summarize, we like to shop in supermarket because of convenience and variety.

**Sample answer 2:**
My family usually shops at the open-air market in my neighbourhood. My mum goes shopping there once every two days. It is only about five minutes' walk from my home, so it is very convenient. There is a wide variety of goods, from groceries to vegetables, from clothes to kitchen utensils, etc. And their price is reasonable. Moreover, the food there is good and fresh as farmers bring their products to sell there every day. We are lucky to have a good shopping place nearby.

### 📝 Grammar Review - Ôn tập ngữ pháp
**Key grammar points from Units 7-8-9:**

1. **Past continuous tense** (Thì quá khứ tiếp diễn)
   - Form: was/were + V-ing
   - Usage: Actions in progress at a specific time in the past

2. **Present simple for scheduled events** (Thì hiện tại đơn cho sự kiện đã lên lịch)
   - Example: The sale starts next Friday.

3. **Word formation** (Cách tạo từ)
   - Adjectives from verbs: destroy → destructive
   - Nouns from adjectives: extinct → extinction
   - Negative prefixes: advantage → disadvantage