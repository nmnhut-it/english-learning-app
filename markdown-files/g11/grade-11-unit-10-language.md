...
### Exercise 1: Use the words in the box to make five compound nouns
...
Use the words in the box to make compound nouns. Then make sentences with them.
...
- **swimming pool** (bể bơi)
  - Example: There is an indoor swimming pool in my villa.

- **sea level** (mực nước biển)
  - Example: The town is 300 feet above sea level.

- **mobile phone** (điện thoại di động)
  - Example: My mother bought me a new mobile phone for my birthday last week.
