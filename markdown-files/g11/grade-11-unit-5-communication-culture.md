# Unit 5: Global Warming - Communication and Culture (Pages 59-60)


**New words** 

1. **I must warn you**: (v) Tôi phải cảnh báo bạn /aɪ mʌst wɔːn juː/
1. **watch out**: (v) Coi chừng /wɒtʃ aʊt/
1. **coal burning stove**: (n) Lò đốt than /kəʊl ˈbɜːnɪŋ stəʊv/
1. **heat up**: (v) làm nóng lên /hiːt ʌp/
1. **soot**: (n) muội than /sʊt/
1. **campfire**: (n) lửa trại /ˈkæmpfaɪə(r)/
1. **expert**: (n) chuyên gia /ˈekspɜːt/
1. **release**: (v) phát thải /rɪˈliːs/
1. **scientist**: (n) nhà khoa học /ˈsaɪəntɪst/
1. **intend**: (v) dự định /ɪnˈtend/
1. **according to research**: (adv) theo nghiên cứu
1. **sign**: (n) dấu hiệu /saɪn/
1. **land-use**: (n) sử dụng đất
1. **dioxide**: (n) điôxít /daɪˈɒksaɪd/
1. **farming**: (n) nông nghiệp /ˈfɑːmɪŋ/
1. **emission**: (n) khí thải /ɪˈmɪʃən/
1. **scientist**: (n) nhà khoa học /ˈsaɪəntɪst/
1. **coal-burn**: (v) đốt than /kəʊl bɜːn/
1. **soot**: (n) muội than /sʊt/
1. **risk**: (n) rủi ro /rɪsk/
1. **scientist**: (n) nhà khoa học /ˈsaɪəntɪst/
...
### Exercise 2: Work in Pairs - Create Similar Conversations

Work in pairs. Use the model in 1 to make similar conversations for these situations. One of you is Student A, the other is Student B.
...
## II. CLIL - Reducing the Environmental Impact of Farming

### Exercise 1: Read and Identify

Read the text and tick (✓) the pictures that show ways to reduce global warming.

#### Reading Text: REDUCING THE ENVIRONMENTAL IMPACT OF FARMING
...
#### Answer Key:
**Good practices (reduce global warming):** Pictures 1, 4
**Bad practices (increase global warming):** Pictures 2, 3, 5

### Exercise 2: Group Discussion

Work in groups. Discuss the following questions:

**Question:** What farming activities in Viet Nam do you think have negative impact on the global temperature? What do you think are the alternatives to those activities?
