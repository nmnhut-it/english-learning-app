...
Pay attention to the falling intonation and level-rising intonation in the following sentences.
...
#### Lời giải chi tiết:
- **1 - d**: restore (v) - to return something to an earlier good condition or position
  (khôi phục (v) - trả lại một cái gì đó về tình trạng hoặc vị trí tốt trước đó)

- **2 - a**: historical (adj) - connected with things from the past
  (thuộc về lịch sử (adj) - kết nối với những thứ trong quá khứ)

- **3 - e**: preserve (v) - to keep something in its original state or in good condition and prevent it from being damaged
  (giữ gìn (v) - giữ một cái gì đó ở trạng thái ban đầu hoặc trong tình trạng tốt và ngăn không cho nó bị hư hỏng)

- **4 - b**: folk (adj) - traditional to a particular group or country, and usually passed down from generation to generation
  (dân gian (adj) - truyền thống của một nhóm hoặc quốc gia cụ thể và thường được truyền từ thế hệ này sang thế hệ khác)

- **5 - c**: historic (adj) - important in history
  (liên quan đến lịch sử (adj) - quan trọng trong lịch sử)
...
#### Lời giải chi tiết:
1. **historical** - Mary enjoys reading historical novels set in World War Two.
   (Mary thích đọc tiểu thuyết lịch sử lấy bối cảnh Thế chiến thứ hai.)

2. **historic** - This meeting of world leaders was a truly historic event that is likely to be remembered in the future.
   (Cuộc gặp gỡ này của các nhà lãnh đạo thế giới là một sự kiện lịch sử thực sự có khả năng được ghi nhớ trong tương lai.)

3. **restore** - The local authority plans to restore the old monument which was damaged by the storm.
   (Chính quyền địa phương có kế hoạch khôi phục tượng đài cũ đã bị bão làm hư hại.)

4. **preserve** - We should increase efforts to preserve ca tru because nowadays there are very few ca tru musicians left.
   (Chúng ta nên tăng cường nỗ lực bảo tồn ca trù vì hiện nay các nhạc công ca trù còn rất ít.)

5. **folk** - Many folk songs tell stories about lives of ordinary people in the past.
...
### Exercise 1: Combine the sentences using to-infinitive clauses
...
Ask and answer questions about heritage sites of traditions, using to-infinitive clauses.
