...
### Bài 2: Read the conversation again. Decide whether the following statements are true (T) or false (F)
...
### Bài 3: Find phrases in the conversation that mean the following
...
### Bài 4: Complete the sentences using phrases from 1
