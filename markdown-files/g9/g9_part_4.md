...
1. speciality (n) \- đặc sản /ˌspeʃ.iˈæl.ɪ.ti/  
2. guess (v) \- đoán /ɡes/   
3. jeep (n) \- xe jeep /dʒiːp/  
4. top (n) \- đỉnh /tɒp/  
5. thrilling (adj) \- hồi hộp /ˈθrɪl.ɪŋ/  
6. ride (n) \- chuyến đi /raɪd/  
7. eco-tour (n) \- du lịch sinh thái /ˈiː.kəʊ tʊər/  
8. area (n) \- khu vực /ˈeə.ri.ə/  
9. rich (adj) \- giàu /rɪtʃ/  
10. flora (n) \- hệ thực vật /ˈflɔː.rə/  
11. fauna (n) \- hệ động vật /ˈfɔː.nə/  
12. plant (n) \- cây /plɑːnt/  
13. animal (n) \- động vật /ˈæn.ɪ.məl/  
14. species (n) \- loài /ˈspiː.ʃiːz/  
15. amazing (adj) \- tuyệt vời /əˈmeɪ.zɪŋ/  
16. take (v) \- chụp /teɪk/  
17. picture (n) \- bức ảnh /ˈpɪk.tʃər/  
18. magnificent (adj) \- tráng lệ /mæɡˈnɪf.ɪ.sənt/  
19. scenery (n) \- phong cảnh /ˈsiː.nər.i/    
20. enjoyable (adj) \- thú vị /ɪnˈdʒɔɪ.ə.bəl/  
21. explore (v) \- khám phá /ɪkˈsplɔːr/  
22. brilliant (adj) \- tuyệt vời /ˈbrɪl.i.ənt/  
23. stream (n) \- suối /striːm/

**Dịch và làm GETTING STARTED** 
...
Tom: Ừ. Chúng tôi đã ghé thăm núi Langbiang và làng Cù Lần. Buổi tối, chúng tôi xem biểu diễn cồng chiêng.
...
**A CLOSER LOOK 1**  
**Vocabulary: (ghi từ vựng sau đó làm bài)**

1. **learning by rote** (n) \- học vẹt /ˈlɜːnɪŋ baɪ rəʊt/  
2. **snorkelling** (n) \- lặn có ống thở /ˈsnɔː.kəl.ɪŋ/  
3. **touring a campus** (v) \- đi xung quanh khuôn viên /ˈtʊərɪŋ ə ˈkæm.pəs/  
4. **parachute jump** (n) \- nhảy dù /ˈpær.ə.ʃuːt dʒʌmp/  
5. **experience** (n) \- kinh nghiệm /ɪkˈspɪə.ri.əns/  
6. **by mistake** (adv) \- nhầm lẫn /baɪ mɪsˈteɪk/  
7. **exhausted** (adj) \- kiệt sức /ɪɡˈzɔː.stɪd/  
8. **facility** (n) \- cơ sở vật chất /fəˈsɪl.ɪ.ti/  
9. **coral reef** (n) \- rạn san hô /ˈkɒr.əl riːf/  
10. **embarrassing** (adj) \- xấu hổ, ngượng ngùng /ɪmˈbær.ə.sɪŋ/  
11. **pleasant** (adj) \- dễ chịu /ˈplez.ənt/  
...
* **Phủ định:**  
  ...
  * Ví dụ: She **has not visited** Paris.  
* **Nghi vấn:**  
  Have/Has \+ S \+ V3/ed \+ (O)?  
...
Thì hiện tại hoàn thành thường được nhận biết qua các từ sau:

* **Just** (vừa mới)  
  * Ví dụ: I have just eaten lunch.  
* **Already** (đã)  
  * Ví dụ: She has already seen that movie.  
* **Yet** (chưa) (trong câu phủ định và nghi vấn)  
  * Ví dụ: Has he finished his work yet? / He hasn’t finished yet.  
* **Ever** (đã từng) (trong câu hỏi)  
  * Ví dụ: Have you ever been to France?  
* **Never** (chưa từng)  
  * Ví dụ: I have never tried sushi.  
* **For** \+ khoảng thời gian  
  * Ví dụ: They have lived here **for** 10 years.  
* **Since** \+ mốc thời gian  
  * Ví dụ: We have known each other **since** 2010\.

### **3\. Ý nghĩa:**

* **Hành động đã hoàn thành nhưng không xác định rõ thời gian**: Hành động đã xảy ra trong quá khứ nhưng không cần biết thời gian cụ thể, chỉ quan tâm đến kết quả.  
  * Ví dụ: I have finished my work. (Tôi đã hoàn thành công việc.)  
* **Hành động bắt đầu trong quá khứ và còn tiếp tục ở hiện tại**: Dùng để chỉ một hành động bắt đầu từ quá khứ và kéo dài đến hiện tại.  
  * Ví dụ: She has lived here for 5 years. (Cô ấy đã sống ở đây được 5 năm.)  
* **Kinh nghiệm trong quá khứ**: Diễn tả những kinh nghiệm hoặc trải nghiệm mà ai đó đã từng có.  
  * Ví dụ: I have been to London. (Tôi đã từng đến London.)
...
1. Chúng tôi đã tham gia trong cuộc thi thể thao của trường một lần   
2. Nam đã không chụp bấtt cứ bức ảnh nào về làng của anh ấy trong hai năm   
3. Họ đã đọc các câu chuyện trinh thám nhiều lần   
4. Tôi chưa bao giờ xem bộ phim đó trước đây  
5. Cô ấy chưa bao giờ gặp em họ của cô ấy kể từ khi cô ấy rời trường 
...
Mother: Are you home yet? It’s 10.pm. now   
Son: Oops, my mistake. I forget about the time  
Mother: Oh, that’s right. But come home now.   
**Bài 3 trang 54**   
**Vocabulary** 

1. **actually** (adv) \- thực ra /ˈæk.tʃu.ə.li/  
2. **ankle** (n) \- mắt cá chân /ˈæŋ.kəl/  
3. **tent** (n) \- lều /tent/  
4. **hurt** (v) \- làm đau /hɜːt/  
5. **slip** (v) \- trượt ngã /slɪp/  
6. **helplessness** (n) \- sự bất lực /ˈhelp.ləs.nəs/  
7. **put up the tents** (phrase) \- dựng lều /pʊt ʌp ðə tents/  
8. **unforgettable** (adj) \- không thể quên /ˌʌn.fəˈɡet.ə.bəl/  
9. **hire** (v) \- thuê /haɪər/  
10. **brilliant** (adj) \- xuất sắc /ˈbrɪl.i.ənt/  
11. **instructor** (n) \- người hướng dẫn /ɪnˈstrʌk.tər/  
12. **snorkel** (n) \- ống thở /ˈsnɔː.kəl/  
13. **exhilarating** (adj) \- phấn khích /ɪɡˈzɪl.ə.reɪ.tɪŋ/  
14. **coral reef** (n) \- rạn san hô /ˈkɒr.əl riːf/

**SKILLS 1**

**Reading** 

**(Các em viết từ vựng rồi dịch bài)** 

**Vocabulary** 

1. **army camp** (n) \- trại quân sự /ˈɑː.mi kæmp/  
2. **wake up** (v) \- thức dậy /weɪk ʌp/  
3. **attend** (v) \- tham dự /əˈtend/  
4. **training course** (n) \- khóa huấn luyện /ˈtreɪ.nɪŋ kɔːs/  
5. **soldier** (n) \- binh lính /ˈsəʊl.dʒər/  
6. **theme** (n) \- chủ đề /θiːm/  
7. **touching moments** (n) \- những khoảnh khắc cảm động /ˈtʌtʃ.ɪŋ ˈməʊ.mənts/  
8. **strict** (adj) \- nghiêm khắc /strɪkt/  
9. **unforgettable** (adj) \- không thể quên được /ˌʌn.fəˈɡet.ə.bəl/  
10. **campus** (n) \- khuôn viên /ˈkæm.pəs/  
11. **outskirts** (n) \- vùng ngoại ô /ˈaʊt.skɜːts/  
12. **communicate** (v) \- giao tiếp /kəˈmjuː.nɪ.keɪt/  
