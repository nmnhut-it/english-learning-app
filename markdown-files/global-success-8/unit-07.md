...
2. **environmental problems** : (n) các vấn đề môi trường /ɪnˌvaɪ.rənˈmen.təl ˈprɒb.ləmz/
3. **environmental protection** : (n) bảo vệ môi trường /ɪnˌvaɪ.rənˈmen.təl prəˈtek.ʃən/
4. **serious** : (adj) nghiêm trọng /ˈsɪə.ri.əs/
5. **pollution** : (n) ô nhiễm /pəˈluː.ʃən/
6. **habitat** : (n) môi trường sống /ˈhæb.ɪ.tæt/
7. **habitat loss** : (n) mất môi trường sống /ˈhæb.ɪ.tæt lɒs/
8. **worse and worse** : (adv) ngày càng tệ hơn /wɜːs ænd wɜːs/
9. **quality** : (n) chất lượng /ˈkwɒl.ɪ.ti/
10. **any others?** : còn cái nào khác không? /ˈeni ˈʌð.əz/
11. **global warming** : (n) sự nóng lên toàn cầu /ˌɡləʊ.bəl ˈwɔː.mɪŋ/
12. **endangered species** : (n) các loài có nguy cơ tuyệt chủng /ɪnˈdeɪn.dʒəd ˈspiː.ʃiːz/
13. **loss** : (n) sự mất mát /lɒs/
14. **protect** : (v) bảo vệ /prəˈtekt/
15. **reduce** : (v) giảm /rɪˈdjuːs/
16. **carbon footprint** : (n) lượng khí thải carbon /ˈkɑː.bən ˈfʊt.prɪnt/
17. **mean** : (v) có nghĩa là, muốn nói /miːn/
18. **carbon dioxide** : (n) khí carbon dioxide /ˌkɑː.bən daɪˈɒk.saɪd/
19. **release** : (v) thải ra /rɪˈliːs/
20. **amount** : (n) lượng (danh từ không đếm được) /əˈmaʊnt/
21. **turning off devices** : (v) tắt thiết bị /ˈtɜː.nɪŋ ɒf dɪˈvaɪsɪz/
22. **device** : (n) thiết bị /dɪˈvaɪs/
23. **practise** : (v) thực hành /ˈpræk.tɪs/
24. **avoid** : (v) tránh /əˈvɔɪd/
25. **litter** : (n) rác, (v) xả rác /ˈlɪt.ər/
26. **volunteer** : (n) tình nguyện viên, (v) tình nguyện /ˌvɒl.ənˈtɪər/
27. **species** : (n) loài /ˈspiː.ʃiːz/
28. **reduce** : (v) giảm /rɪˈdjuːs/
29. **reuse** : (v) tái sử dụng /ˌriːˈjuːz/
30. **recycle** : (v) tái chế /ˌriːˈsaɪ.kəl/
31. **single-use** : (adj) dùng một lần /ˌsɪŋ.ɡəlˈjuːs/
32. **product** : (n) sản phẩm /ˈprɒd.ʌkt/
33. **dump** : (v) thả, xả /dʌmp/
34. **waste** : (n) chất thải /weɪst/
35. **throw - threw - thrown** : (v) ném, bỏ đi /θrəʊ - θruː - θrəʊn/
36. **rubbish = trash** : (n) rác /ˈrʌb.ɪʃ/, /træʃ/
...
*Viết một cụm từ từ hộp dưới mỗi bức tranh*
...
1. **campfire** : (n) lửa trại /ˈkæmpfaɪər/
...
16. **particular** : (adj) đặc biệt, cụ thể /pəˈtɪkjələr/
17. **area** : (n) khu vực, lĩnh vực /ˈeəriə/
18. **related to** : liên quan tới /rɪˈleɪtɪd tuː/
19. **each other** : lẫn nhau /iːtʃ ˈʌðər/
...
33. **concern** : (n) mối quan ngại, mối lo /kənˈsɜːn/
...
#### Bài 1: Read the sentences and write I.C if the underlined clause is an independent clause or D.C if it is a dependent clause
...
- **What do you mean by ...?** : Bạn muốn nói gì qua ...?
- **It means...** : Nó có nghĩa là...

### 🗣️ Activities - Hoạt động

#### Bài 1: Listen and read the dialogue. Pay attention to the highlighted sentences
*Nghe và đọc đoạn hội thoại. Chú ý những câu được làm nổi bật*

#### Bài 2: Work in pairs. Make similar conversations to ask for and give clarification
*Làm việc theo cặp. Tạo các cuộc hội thoại tương tự để hỏi và làm rõ*

**Example:**
A: What does 'single-use products' mean? / What do you mean by 'single-use products'?
B: 'Single-use products' are products made to be used once only.

A: And what does 'global warming' mean? / What do you mean by 'global warming'?
...
*Đọc đoạn văn và đánh dấu (✓) câu trả lời đúng*

**Earth Day**

Every year, on 22nd April, more than 190 countries celebrate Earth Day to protect the planet. The first Earth Day started in 1970 in America. Today, more than 1 billion people participate in Earth Day activities each year, making it one of the largest movements. By taking part in activities like picking up litter and planting trees, you can help protect nature and the environment. You can also do things like buying green products and practising reduce, reuse, and recycle. We can celebrate Earth Day and protect our earth at the same time. Moreover, we should continue to do things to save the earth every day of the year.
...
✓ 4. buying green products (mua sản phẩm xanh)

#### Bài 4: Match the activities people do on Earth Day with their results
*Nối các hoạt động người ta làm trong Ngày Trái Đất với kết quả của chúng*

1. b - planting trees → reducing pollution and making the air clean
   *trồng cây → giảm ô nhiễm và làm sạch không khí*

2. d - buying green products → improving our health and reducing pollution
   *mua sản phẩm xanh → cải thiện sức khỏe và giảm ô nhiễm*

3. a - picking up litter → making our environment clean
   *nhặt rác → làm cho môi trường của chúng ta sạch*

4. c - turning off lights → saving electricity and saving natural resources
   *tắt đèn → tiết kiệm điện và tiết kiệm tài nguyên thiên nhiên*
...
*Ở Việt Nam, bây giờ có 34 công viên quốc gia. Công viên quốc gia Côn Đảo là một trong số chúng. Nó đã trở thành một công viên quốc gia vào năm 1993. Công viên thì ở huyện Côn Đảo, tỉnh Bà Rịa - Vũng Tàu. Nó chứa 16 đảo nhỏ bao phủ 20.000 héc-ta. Hệ sinh thái ở đây thì rất đa dạng với hàng nghìn loài, bao gồm các động vật biển. Nhiều loài san hô cũng như là rùa biển, cá heo và những con bò biển bị nguy hại cũng sống ở đây. Công viên thì cũng là nhà của nhiều loại gỗ và cây thuốc có giá trị. Ba loại cây cổ trong công viên được đặt tên là "Những cây di sản của Việt Nam".*
...
*Đọc văn bản và chọn từ hoặc cụm từ để làm cho các câu sau đúng*
...
#### Bài 3: Read the text again and choose the correct option A, B or C
*Đọc lại văn bản và chọn phương án đúng A, B hoặc C*

1. What is the best title for the passage?
   **Answer:** B. Con Dao National Park

2. National parks are areas for _____.
   **Answer:** A. the protection of the environment

3. What is the area of Con Dao National Park?
   **Answer:** C. 20,000 hectares

4. Con Dao National Park has many kinds of _____.
   **Answer:** A. valuable plants

5. Which of the following is NOT true, according to the passage?
   **Answer:** C. Con Dao National Park's mission is to help other national parks.

### 🗣️ Speaking - Nói

#### Bài 4: Work in pairs. Ask and answer about Vu Quang National Park
*Làm việc theo cặp. Hỏi và trả lời về Vườn quốc gia Vũ Quang*

**Example dialogue:**
A: Where is Vu Quang National Park?
B: It's in Vu Quang District, Ha Tinh Province.

A: When was Vu Quang National Park opened?
B: It was opened in 2002.

A: What is the area of Vu Quang National Park?
B: About 55,000 hectares.

A: What kind of species does Vu Quang National Park have?
B: It has Saolas, "black deer" and also valuable plants, woods, medicinal plants.

#### Bài 5: Work in groups. Talk about Vu Quang National Park
*Làm việc nhóm. Nói về Vườn quốc gia Vũ Quang*

Vu Quang National Park is in Vu Quang district, Ha Tinh Province. It was opened in 2002. It has an area of about 55,000 hectares. The park is home to many kinds of species such as saolas, "black deer" and also valuable woods and medicinal plants.
...
18. **litter** : (v) xả rác /ˈlɪtər/
19. **single-use product** : sản phẩm dùng một lần /ˈsɪŋɡl juːs ˈprɒdʌkt/
20. **plastic bag** : túi nhựa /ˈplæstɪk bæɡ/

### 👂 Listening - Nghe

#### Bài 2: Listen to the conversation and choose the correct word to complete each sentence
*Nghe cuộc hội thoại và chọn từ đúng để hoàn thành mỗi câu*

1. Water pollution is a **serious** problem.
2. Polluted water is unsafe for **drinking** and for other uses.
3. Sometimes toxic substances flow into rivers from **factories**.
4. Water pollution has a **harmful** effect on our life.
5. We **shouldn't** throw litter into rivers and lakes.

#### Bài 3: Listen again and give short answers to the following questions
*Nghe lại và trả lời ngắn các câu hỏi sau*

1. What is the topic of the TV programme?
   **Answer:** water pollution

2. How many sources of water pollution are there?
   **Answer:** two

3. What are two sources of water pollution?
   **Answer:** rivers and lakes

4. What does water pollution have on our life?
   **Answer:** harmful effect

5. What should we do to reduce water pollution?
   **Answer:** (use) green products

### ✍️ Writing - Viết

#### Bài 4: Work in pairs. Read the notice and match the headings (a-e) below with the numbers (1-5)
*Làm việc theo cặp. Đọc thông báo và nối các tiêu đề (a-e) bên dưới với các số (1-5)*

1. a - Name of the writer
2. c - Contact details
3. b - Body
4. e - Date
5. d - Subject of the notice

#### Bài 5: Write a notice for the Go Green Club leader to invite students to attend a lecture on water pollution
*Viết thông báo cho trưởng câu lạc bộ Go Green để mời học sinh tham dự bài giảng về ô nhiễm nước*
...
Go Green Club is organising a lecture on Water Pollution. Students from all the classes can participate. Interested students should contact the club by 20 February, 2025.
...
1. We should reduce the use of _____ to help the environment.
   **Answer:** A. plastic bags

2. You should _____ if you want to reduce air pollution.
   **Answer:** C. ride a bike

3. The opposite of "reduce" is _____.
   **Answer:** B. increase

4. _____ is bad for the environment.
   **Answer:** A. Cutting down trees

5. People should use more _____ to help the environment.
   **Answer:** C. green products

#### Bài 2: Complete each of the sentences with a word or phrase from the box
*Hoàn thành mỗi câu với một từ hoặc cụm từ từ hộp*

1. Don't **litter** the streets with your rubbish!
2. Governments should make plans to reduce their **carbon footprint**.
3. Today we're **picking up rubbish** around our school.
4. Deforestation destroys the **habitats** of many animals.
5. We shouldn't hunt **endangered species** for any reason.

### ✍️ Grammar Review - Ôn tập ngữ pháp

#### Bài 3: Complete the following sentences using a clause
*Hoàn thành các câu sau sử dụng mệnh đề*

1. We should wait here **until he gets back**.
2. **As soon as I arrived**, I called him.
3. Remember to lock the door **before you go out**.
4. There were not many animals on the mountain **after they destroyed the forest**.
...
1. Global warming will **affect** **because** → **as soon as** there will be more droughts.
2. We can find **until** → **when** many animals in their natural habitats.
3. **Will** → **(no will)** you come **before** you finish the report?
4. If you need help, **while** → **when/if** I will come and help you.
5. **Earth Hour this year** → **did** take place **on** 25 March.