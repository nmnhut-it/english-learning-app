...
**Bài 2 trang 93:** Read the conversation again. Complete each sentence with no more than TWO words from it.
(Đọc đoạn hội thoại một lần nữa. Hoàn thành mỗi câu với không quá HAI từ từ nó.)

1. Mi's uncle's family had to move everything to the _____ floor.
2. A tornado is a violent _____ that moves in a circle.
3. Tom's family _____ dinner when the tornado came.
4. The tornado damaged their roof and _____ up some trees in their yard.
...
**Bài 3 trang 93:** Write the natural disasters from the box under the pictures. Then listen, check, and repeat.
...
(Trọng âm trong các từ kết thúc bằng -al và -ous)
...
**Bài 1 trang 94:** In column B, write the noun forms of the verbs in column A.
...
**Bài 2 trang 94:** Write a word or phrase from the box under the correct picture.
...
**Bài 3 trang 94:** Fill in each blank with a word or phrase from the box.
...
**Bài 1 trang 95:** Complete the sentences by putting the verbs in brackets into the past continuous.
(Hoàn thành câu bằng cách chia động từ trong ngoặc ở thì quá khứ tiếp diễn.)

1. They _____ (help) the flood victims at 10 o'clock last night.
2. It _____ (not snow) when I left home this afternoon.
3. While she _____ (work) in the field, the tornado came.
4. What _____ you _____ (do) at 9 o'clock yesterday morning?
   - I _____ (watch) the news about a volcanic eruption.
5. _____ you _____ (cry) when I saw you two days ago?
   - No, I _____.
...
2. wasn't snowing
3. was working
4. were you doing / was watching
5. Were you crying / wasn't
...
- **That's awful** : Thật tồi tệ
- **That's shocking** : Thật sốc
- **That's terrible** : Thật khủng khiếp
- **How terrible** : Thật kinh khủng
- **Oh no** : Ôi không
- **I hope... are safe** : Tôi hy vọng... được an toàn
...
Mark: Thật tồi tệ. Tôi hy vọng ông bà của bạn được an toàn.
...
**Bài 4 trang 97:** Choose the correct answer to each question to see how much you know about natural disasters.
...
Đây là Đài phát thanh xã An Bình. Mùa mưa đang đến nên chương trình đặc biệt hôm nay sẽ nói cho bạn biết về những gì bạn nên làm trước, trong và sau cơn bão. Trước cơn bão, mỗi gia đình nên chuẩn bị một bộ dụng cụ khẩn cấp với những thứ cần thiết như băng dán, thuốc cơ bản, còi, chai nước, thức ăn, v.v. Mang những thứ ngoài trời như chậu hoa hoặc thùng rác vào nhà vì chúng có thể bị gió mạnh thổi bay. Gia cố nhà cửa nếu cần thiết.

Trong cơn bão, hãy ở trong nhà. Ngay cả khi mưa và gió ngừng, hãy chờ đợi vì cơn bão có thể bắt đầu trở lại. Tránh xa cửa sổ và cửa kính. Chúng có thể vỡ và làm bạn bị thương. Tập trung trong phòng an toàn nhất trong nhà.

Sau cơn bão, đừng rời khỏi nhà ngay lập tức. Lắng nghe những hướng dẫn quan trọng từ chính quyền địa phương. Họ có thể cảnh báo bạn về những khu vực nào trong vùng của bạn nguy hiểm và nên tránh. Tránh xa đường dây điện bị đứt.

### ✍️ Exercises - Bài tập

**Bài 2 trang 99:** Listen to a broadcast. Put the activities (1-6) in the correct column.
(Nghe một chương trình phát sóng. Đặt các hoạt động (1-6) vào đúng cột.)

1. Take in outdoor things
2. Prepare an emergency kit
3. Stay away from windows and glass doors
4. Listen to local authorities
5. Gather in the safest room in the house
6. Strengthen your house

**Answer:**
- Before a storm: 2, 6, 1
- During a storm: 3, 5
- After a storm: 4
...
3. Right after the storm, you can leave your house. _____
...
- Listen to local radio (Lắng nghe đài phát thanh địa phương)
- Protect your valuables in waterproof containers (Bảo vệ tài sản trong thùng chống nước)
- Place them above potential water levels (Đặt chúng lên cao)

**During a flood (Trong khi có lũ):**
- Stay inside a safe and high place (Ở trong nơi an toàn và cao)
- Follow the routes specified by officials (Làm theo lộ trình của chính quyền)
- If time allows, leave a note informing others when you left and where you went (Nếu có thời gian, để lại ghi chú)

**After a flood (Sau khi có lũ):**
- Avoid moving water (Tránh nước đang chảy)
- Emergency workers will be assisting people (Nhân viên cứu hộ sẽ hỗ trợ)
- Return home only when authorities indicate it is safe (Chỉ về nhà khi chính quyền thông báo an toàn)

**Bài 5 trang 99:** Write instructions (80-100 words) about things to do before, during, and after a flood.
...
**Actions and effects:**
- destroy/destruction (phá hủy/sự phá hủy)
- damage (thiệt hại)
- erupt/eruption (phun trào/sự phun trào)
- warn/warning (cảnh báo/lời cảnh báo)
- predict/prediction (dự đoán/sự dự đoán)

**Emergency items:**
- emergency kit (bộ dụng cụ khẩn cấp)
- whistle (còi)
- plaster (băng dán)
- basic medicine (thuốc cơ bản)
