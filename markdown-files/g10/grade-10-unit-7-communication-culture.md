# Unit 7: Viet Nam and International Organisations - Communication and Culture

## EVERYDAY ENGLISH: Making and responding to invitations
*(Đưa ra và phản hồi lời mời)*

### Vocabulary

1. **invitation** /ˌɪnvɪˈteɪʃn/ (n): lời mời
2. **accept** /əkˈsept/ (v): chấp nhận
3. **decline** /dɪˈklaɪn/ (v): từ chối
4. **formal** /ˈfɔːml/ (adj): trang trọng
5. **informal** /ɪnˈfɔːml/ (adj): không trang trọng
6. **delighted** /dɪˈlaɪtɪd/ (adj): vui mừng
7. **art exhibition** /ɑːt ˌeksɪˈbɪʃn/ (n.phr): triển lãm nghệ thuật
8. **on time** /ɒn taɪm/ (adv.phr): đúng giờ
9. **never mind** /ˈnevə maɪnd/ (phrase): đừng bận tâm
...
*(Nghe và hoàn thành các cuộc hội thoại với các diễn đạt trong hộp. Sau đó thực hành chúng theo cặp.)*
...
*(Bạn muốn mời một người bạn tham gia cùng bạn trong một hoạt động. Làm việc theo cặp. Thực hiện các cuộc trò chuyện tương tự như cuộc trò chuyện trong 1. Sử dụng các cách diễn đạt hữu ích dưới đây để giúp bạn.)*

#### Useful Expressions (Các cách diễn đạt hữu ích)

| | Making invitations | Accepting | Declining |
|-|-------------------|-----------|-----------|
| **Informal** | Do you want to...? | Sure. I'll be there. | I'm sorry, but I can't. |
| *(Không trang trọng)* | Do you feel like...? | Yes, I'd love to. | Sorry, maybe next time. |
| | Let's go to... | | |
| **Formal** | Would you like to...? | I would be delighted. | Oh, I'd love to, but... |
| *(Trang trọng)* | Would you care to...? | Thank you very much for inviting me. | That's very kind of you, but... |

#### Hướng dẫn dịch:

| | Đưa ra lời mời | Chấp nhận lời mời | Từ chối lời mời |
|-|----------------|-------------------|-----------------|
| **Không trang trọng** | Bạn có muốn...? | Chắc chắn rồi. Tôi sẽ có mặt. | Tôi xin lỗi, nhưng tôi không thể. |
| | Bạn có thích...? | Vâng, tôi rất thích. | Xin lỗi, hẹn lần sau nhé. |
| | Chúng ta hãy đi... | | |
| **Trang trọng** | Bạn có muốn...? | Tôi sẽ rất vui. | Ờ, tôi muốn lắm, nhưng... |
| | Bạn có quan tâm đến...? | Cảm ơn rất nhiều vì đã mời tôi. | Bạn thật tốt bụng, nhưng... |
...
1. **FAO** /ˌefˌeɪˈəʊ/ (n): Tổ chức Nông lương Liên Hợp Quốc (Food and Agriculture Organisation)
2. **hunger** /ˈhʌŋɡə/ (n): nạn đói
3. **poverty** /ˈpɒvəti/ (n): nghèo đói
4. **nutrition** /njuˈtrɪʃn/ (n): dinh dưỡng
5. **standard of living** /ˈstændəd əv ˈlɪvɪŋ/ (n.phr): mức sống
6. **agricultural products** /ˌæɡrɪˈkʌltʃərəl ˈprɒdʌkts/ (n.phr): sản phẩm nông nghiệp
7. **food security** /fuːd sɪˈkjʊərəti/ (n.phr): an ninh lương thực
8. **technical support** /ˈteknɪkl səˈpɔːt/ (n.phr): hỗ trợ kỹ thuật
9. **access to** /ˈækses tuː/ (n.phr): tiếp cận với

---

### Bài đọc: FAO AND ITS ACTIVITIES TO SUPPORT VIET NAM
...
1. **1945** - The Food and Agriculture Organisation of the United Nations (FAO) was formed in 1945.

2. **end hunger and poverty** - Its main aim is to end hunger and poverty by making sure all people have access to healthy food.
...
*(Làm việc theo cặp. Sử dụng sơ đồ trong 1 để nói về FAO và các hoạt động của tổ chức này tại Việt Nam.)*
...
**B:** That's very impressive. FAO has contributed a lot to Viet Nam's agricultural development.

**A:** Yes, and it continues to support Viet Nam in improving nutrition and food security for all people.
...
**A:** Tuyệt vời. FAO cũng đã bắt đầu hoạt động tại Việt Nam.

**B:** Đúng vậy. Bạn có thể chia sẻ một chút về FAO tại Việt Nam được không?
...
**B:** Thật ấn tượng. FAO đã đóng góp rất nhiều cho sự phát triển nông nghiệp của Việt Nam.

**A:** Đúng vậy, và tổ chức này tiếp tục hỗ trợ Việt Nam cải thiện dinh dưỡng và an ninh lương thực cho tất cả mọi người.

---

## Từ vựng tổng hợp

1. **end** /end/ (v): chấm dứt
   - Its main aim is to end hunger and poverty.

2. **raise** /reɪz/ (v): nâng cao
   - It hopes to raise the levels of nutrition.

3. **improve** /ɪmˈpruːv/ (v): cải thiện
   - It tries to improve the production of food.

4. **reach** /riːtʃ/ (v): tiếp cận, đến được
   - Make sure they reach all groups of society.

5. **provide** /prəˈvaɪd/ (v): cung cấp
   - It has provided Viet Nam with technical support.

6. **carry out** /ˈkæri aʊt/ (phr.v): thực hiện
   - It has helped Viet Nam carry out about 400 projects.

7. **essential** /ɪˈsenʃl/ (adj): cần thiết
   - Good nutrition is essential for normal growth.
