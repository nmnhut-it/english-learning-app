# Review 4: Language (Ôn tập Unit 9-10)

## Pronunciation: Sentence Stress (Trọng âm câu)

### Lý thuyết
Trọng âm câu là sự nhấn mạnh vào một vài từ nhất định trong câu. Chúng ta thường nhấn vào các từ chứa nội dung câu, như:
- Động từ chính (main verbs)
- Danh từ (nouns)
- Tính từ (adjectives)
- Trạng từ (adverbs)

Các từ không nhấn thường là:
- Mạo từ (a, an, the)
- Giới từ (in, on, at, to)
- Đại từ (I, you, he, she)
- Trợ động từ (is, are, do, does)

### Exercise: Mark the stressed syllables in the words in bold. Listen and repeat, paying attention to the rhythm.
(Đánh dấu các âm tiết được nhấn mạnh trong các từ được in đậm. Nghe và nhắc lại, chú ý đến nhịp điệu.)
...
1. I ˈlike ˈtrekking in the ˈmountains.
   - Tôi thích trekking trên núi.

2. The ˈchildren are ˈlooking ˈforward to the ˈboat ˈtrip.
   - Các em nhỏ mong chờ chuyến đi chơi thuyền.

3. Are you going to ˈvisit the muˈseum toˈmorrow?
   - Bạn có định đi thăm viện bảo tàng vào ngày mai không?

4. ˈDon't ˈlitter while you are on the ˈecotour.
...
### Exercise 1: Complete the following sentences using the phrases from the box.
...
1. **tourist attraction** - Trong nhiều năm, bảo tàng lịch sử đã là một điểm thu hút khách du lịch lớn của thành phố.

2. **endangered animals** - Nếu không ngăn chặn được việc săn bắt trái phép các loài động vật có nguy cơ tuyệt chủng, sự cân bằng của hệ sinh thái sẽ bị phá hủy.

3. **global warming** - Nhiệt độ cao hơn và các hiện tượng thời tiết khắc nghiệt hơn là do sự nóng lên toàn cầu.

4. **Environmental protection** - Các chương trình bảo vệ môi trường nhằm giảm thiểu rủi ro đối với môi trường.

5. **responsible tourism** - Một trong những lợi ích của du lịch có trách nhiệm là nó tạo ra cơ hội việc làm cho người dân địa phương.

---

### Exercise 2: Choose the correct word or phrase to complete each of the following sentences.
...
1. **ecosystem** - Ô nhiễm là một trong những nguyên nhân chính dẫn đến sự tàn phá hệ sinh thái.
   - ecotour (n): chuyến du lịch sinh thái
   - ecosystem (n): hệ sinh thái

2. **eco-friendly** - Chúng ta sẽ có chuyến đi dã ngoại thân thiện với môi trường đến vùng nông thôn vào cuối tuần này.
   - eco-friendly (adj): thân thiện với môi trường
   - user-friendly (adj): thân thiện với người dùng

3. **litter** - Khách du lịch không được phép xả rác trong công viên.
   - litter (v): xả rác
   - rubbish (n): rác thải

4. **Ecotourism** - Du lịch sinh thái giúp bảo vệ môi trường tự nhiên.
   - Mass tourism (n): du lịch đại chúng
   - Ecotourism (n): du lịch sinh thái

5. **biodiversity** - Mất môi trường sống là một trong những mối đe dọa lớn nhất đối với đa dạng sinh học.
...
5. **The teacher explained that the animals would not survive extreme cold weather in the North.**
   - Giáo viên giải thích rằng các loài động vật sẽ không thể sống sót trong thời tiết cực lạnh ở miền Bắc.

---

### B. Conditional Sentences Type 1 & Type 2 (Câu điều kiện loại 1 và loại 2)

#### Lý thuyết

**Type 1 - Điều kiện có thể xảy ra (Real condition):**
- Cấu trúc: If + S + V(s/es), S + will/can/may + V
- Dùng để diễn tả điều kiện có thể xảy ra ở hiện tại hoặc tương lai

**Type 2 - Điều kiện không có thật (Unreal condition):**
- Cấu trúc: If + S + V(ed)/were, S + would/could/might + V
- Dùng để diễn tả điều kiện không có thật ở hiện tại

---

### Exercise 2: Match the two parts to make complete sentences.
...
1 - d. **If we keep cutting down forests, deforestation will be more serious.**
   - Nếu chúng ta cứ chặt phá rừng thì nạn phá rừng sẽ ngày càng nghiêm trọng hơn. (Type 1)

2 - a. **If we use public transport more, our cities will get cleaner.**
   - Nếu chúng ta sử dụng phương tiện công cộng nhiều hơn, các thành phố của chúng ta sẽ sạch hơn. (Type 1)

3 - c. **If global warming continues, the sea level will rise.**
   - Nếu hiện tượng nóng lên toàn cầu tiếp tục, mực nước biển sẽ dâng cao. (Type 1)

4 - e. **If the laws on illegal hunting were stricter, more animals would be saved.**
   - Nếu luật săn bắn trái phép được kiểm soát chặt chẽ hơn, thì sẽ có nhiều động vật được cứu hơn. (Type 2)

5 - b. **If there were no air and water, there would be no life on earth.**
   - Nếu không có không khí và nước, sẽ không có sự sống trên trái đất. (Type 2)
