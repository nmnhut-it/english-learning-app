...
### Exercise 1: Read about chau van singing
...
1. **artists** /ˈɑːtɪst/ (n): nghệ sĩ
   - Wow, so many famous artists are going to perform there.
...
3. **spread** /spred/ (v,n): lan truyền
   - It started in the Northern Delta region of Viet Nam around the 16th century, and later spread to all parts of the country.

4. **praise** /preɪz/ (v): tuyên dương
   - It is used to praise the gods or national heroes.

5. **worship singing** /ˈwɜːʃɪp ˈsɪŋɪŋ/ (n.phr): hát thờ
   - One typical type is hat tho or worship singing - the slow chanting including an act of worship.

6. **psychic** /ˈsaɪkɪk/ (n): nhà ngoại cảm
   - Another type is hat hau- the singing and dancing of a psychic.
...
9. **costumes** /ˈkɒstjuːmz/ (n): trang phục
   - The costumes of chau van performers are very important.

10. **depend on** /dɪˈpend ɑːn/ (phr.v): phụ thuộc vào
    - The style of clothes, hats, and belts depends on the rank of the gods or saints the performers worship.
