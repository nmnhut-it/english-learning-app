...
Chào Mi. Lâu rồi không gặp. Bạn thế nào rồi?

**Mi**: I'm fine, thanks. By the way, we moved to a new house in a suburb last month.
Tôi ổn, cảm ơn. Nhân tiện, tháng trước chúng tôi đã chuyển đến một ngôi nhà mới ở ngoại ô.

**Ann**: Oh, that's why I haven't seen you in the Reading Club very often.
Ồ, đó là lý do tại sao tôi không thường xuyên gặp bạn ở Câu lạc bộ Đọc sách.

**Mi**: Yes. We're still busy moving in, you know.
Vâng. Chúng tôi vẫn đang bận chuyển đi, bạn biết đấy.

**Ann**: How is your new neighbourhood?
Khu phố mới của bạn thế nào?

**Mi**: It's much bigger than our old one. The streets are wider, and there are fewer people.
Nó lớn hơn cái cũ của chúng tôi nhiều. Đường phố rộng hơn và có ít người hơn.

**Ann**: What about the facilities?
Còn cơ sở vật chất thì sao?

**Mi**: It has all the things we need: shopping malls, parks, and hospitals. And there's a craft village near our house.
Nó có tất cả những thứ chúng tôi cần: trung tâm mua sắm, công viên và bệnh viện. Và có một làng nghề gần nhà chúng tôi.

**Ann**: Great! How're your new neighbours?
Tuyệt! Hàng xóm mới của bạn thế nào?
...
Họ tốt lắm. Chủ nhật tuần trước khi tôi đang tìm đường đến bến xe buýt, một phụ nữ đã đến và chỉ đường cho tôi. Tôi nghĩ chúng tôi sẽ hòa hợp với họ.
...
Điều đó làm tôi nhớ đến thời gian gia đình chúng tôi chuyển đến Việt Nam. Chúng tôi không biết mua đồ đạc cho ngôi nhà của mình ở đâu và những người hàng xóm mới trong cộng đồng đã cho chúng tôi những lời khuyên hữu ích. Tôi đoán bạn thích nơi ở mới của bạn.

**Mi**: Sure. I really love where I live now.
Chắc chắn rồi. Tôi thực sự yêu nơi tôi đang sống hiện tại.

### ✍️ Exercises - Bài tập

**Bài 1: Listen and read**
(Nghe và đọc - đã có nội dung ở trên)

**Bài 2: Read the conversation again. Fill in each blank with no more than TWO words from the conversation.**
...
3. There's a _______ near Mi's house.
4. Mi thinks she will _______ her new neighbours.
...
**Bài 3: Match each word or phrase with its definition.**
(Nối mỗi từ hoặc cụm từ với định nghĩa của nó.)

1. suburb - b. an area outside the centre of a city
2. facilities - e. buildings, equipment, and services provided for a particular purpose
3. community - a. the people living in a particular area; the place where people live
4. get on with - c. to have a good relationship with somebody
5. remind sb of - d. to make somebody remember or think about somebody or something

**Bài 4: Complete each sentence with a word or phrase from 3.**
...
- /æ/: ngắn, miệng mở rộng ngang
  - Examples: **hand** /hænd/, **craft** /kræft/, **attraction** /əˈtrækʃn/

- /ɑː/: dài, miệng mở rộng dọc  
  - Examples: **artisan** /ˌɑːtɪˈzæn/, **park** /pɑːk/, **car** /kɑː/

### ✍️ Exercises - Bài tập

**Bài 1: Write a word or phrase in the box under the correct picture.**
(Viết một từ hoặc cụm từ trong hộp dưới bức tranh đúng.)
...
**1. Question words before to-infinitive (Từ để hỏi trước động từ nguyên mẫu có to)**

Structure: Question word + to-infinitive

- what to do (làm gì)
- where to go (đi đâu)  
- when to start (khi nào bắt đầu)
- who to ask (hỏi ai)
- how to do it (làm thế nào)

Examples:
- I don't know **what to do**.
  Tôi không biết phải làm gì.
- Can you tell me **where to buy** local specialities?
  Bạn có thể cho tôi biết mua đặc sản địa phương ở đâu không?
...
4. They asked _______ to take care of the plants when they were away.
...
**Useful expressions for asking for help:**
...
**Bài 1: Listen and read the conversations. Pay attention to the questions and answers.**
(Nghe và đọc các cuộc hội thoại. Chú ý đến các câu hỏi và câu trả lời.)

**Bài 2: Work in pairs. Ask for help and respond in the following situations.**
(Làm việc theo cặp. Yêu cầu giúp đỡ và trả lời trong các tình huống sau.)

**Bài 3: Do you know the place in each picture?**
(Bạn có biết địa điểm trong mỗi bức tranh không?)

**Bài 4: Listen to Binh and Mira talking about a place of interest in their community. Fill in each blank with no more than TWO words and/or a number.**
...
**SPECIAL PLACES WITH SPECIAL PRODUCTS**
...
**Làng Vòng (Hà Nội)**
Vòng, một ngôi làng nhỏ ở Hà Nội, nổi tiếng với món ăn đặc sản: cốm (hạt nếp non). Để làm cốm, các nghệ nhân thực hiện theo một loạt các bước. Họ bảo tồn các kỹ thuật bằng cách truyền lại cho con trai của họ. Trong quá khứ, người ta làm cốm bằng tay, nhưng bây giờ họ sử dụng máy móc cho một số bước để rút ngắn quy trình. Họ gói sản phẩm cuối cùng trong hai lớp lá để bảo quản hương thơm trước khi bán cho người tiêu dùng. Cốm Làng Vòng nổi tiếng ở Việt Nam như một đặc sản của mùa thu Hà Nội.

**Denby Village (Derbyshire, England)**
...
**Listening transcript:**
This is An Binh commune radio station. In today's special programme, we will share with you a piece of writing which won first prize in our writing contest called "My favourite community helper". This was written by Mi, a grade nine student. 

There are many great community helpers in our neighbourhood. But my favourite one is Mr. Vinh, the garbage collector. Mr. Vinh is a tall and slim man. He usually wears a green uniform with reflective stripes. He is hardworking and responsible. Every day he goes to our neighbourhood at 06:00 p.m with a garbage cart. He instructs everyone to put garbage in the correct bin, recyclable and non-recyclable, and then goes to the next neighbourhood at about 09:00 p.m. He comes back and empties all the bins carefully.

**Vietnamese translation:**
Đây là đài phát thanh xã An Bình. Trong chương trình đặc biệt hôm nay, chúng tôi sẽ chia sẻ với bạn một bài viết đã đoạt giải nhất trong cuộc thi viết của chúng tôi có tên "Người giúp đỡ cộng đồng mà tôi yêu thích nhất". Bài viết này được viết bởi Mi, một học sinh lớp chín.

Có rất nhiều người giúp đỡ cộng đồng tuyệt vời trong khu phố của chúng tôi. Nhưng người tôi yêu thích nhất là ông Vinh, người thu gom rác. Ông Vinh là một người đàn ông cao và gầy. Ông thường mặc đồng phục màu xanh lá cây với các dải phản quang. Ông chăm chỉ và có trách nhiệm. Mỗi ngày ông đến khu phố của chúng tôi lúc 6 giờ chiều với một xe thu gom rác. Ông hướng dẫn mọi người bỏ rác vào đúng thùng, có thể tái chế và không thể tái chế, và sau đó đi đến khu phố tiếp theo vào khoảng 9 giờ tối. Ông quay lại và dọn sạch tất cả các thùng rác một cách cẩn thận.

### ✍️ Writing - Viết

**Write about your favourite community helper**

### ✍️ Exercises - Bài tập

**Bài 1: Who can you see in the pictures?**
(Bạn nhìn thấy ai trong các bức tranh?)

Suggested answers: firefighters, nurses, police officers, garbage collectors

**Bài 2: Listen and fill in each blank with no more than TWO words.**
...
1. Mi is a student at An Binh School. - F
2. Mi's favourite community helper is a garbage collector. - T
3. He goes to Mi's neighbourhood at 6 a.m. every day. - F
4. He instructs people to put rubbish in two types of bins. - T
5. He shares information about his work and the importance of sorting rubbish. - T

**Bài 4: Work in pairs. Choose a community helper you like and answer the questions.**
(Làm việc theo cặp. Chọn một người giúp đỡ cộng đồng mà bạn thích và trả lời các câu hỏi.)

**Bài 5: Write a paragraph (about 100 words) about your favourite community helper.**
(Viết một đoạn văn (khoảng 100 từ) về người giúp đỡ cộng đồng mà bạn yêu thích.)

**Sample answer:**
My favourite community helper is a firefighter. He usually wears special protective uniform. He is dedicated, brave and quick-thinking. He can handle many different emergency situations, often risking his life to ensure the safety of others. He responds to fire incidents, accidents, and natural disasters to protect lives and property for the community. Besides extinguishing fires, he also participates in rescue activities and manages emergency medical aid. He also participates in public programs, educating people about safety and fire prevention. I greatly respect and appreciate him. His selfless dedication to serving the community is truly admirable. He is truly a real-life hero.
...
2. They don't know _____ to preserve the environment.
   A. what  B. how  C. where  D. when
3. My mother wondered _____ to buy at the traditional market.
   A. how  B. where  C. when  D. what
4. He's wondering _____ to ask for advice?
