...
Thái, Đạt, Nghĩa, Khang, Khiết, Minh, Bảo An, Đăng, Nhân không được ra chơi 

Minh: Ôi, một cái kẹt xe khác.  
Ann: Làm sao chúng ta sẽ đến địa điểm cắm trại đúng giờ bây giờ?  
Minh: Tôi không biết. Thật đáng tiếc rằng chúng ta không có một hyperloop bây giờ\!  
Ann: Hyperloop là gì?  
Minh: Nó là một hệ thống của những ống. Bạn có thể đi từ một nơi đến một nơi khác chỉ trong vài phút.  
Ann: Tuyệt vời\! Thậm chí nhanh hơn một chiếc xe bay\!  
Minh: Vâng, và không có tắc đường.  
Ann: Liệu nó sẽ gây ô nhiễm môi trường?  
Minh: Không. Sẽ không có khói thải, và nó hoàn toàn an toàn.  
Ann: Giống như một máy dịch chuyển?  
Minh: Một máy dịch chuyển cũng nhanh, an toàn và thân thiện với môi trường. Nhưng nó là một phương thức di chuyển khác.  
Ann: Vậy khi chúng ta di chuyển trong những hyperloop, chúng ta sẽ không phải lo lắng về thời tiết xấu, đúng không?  
Minh: Đúng.  
Ann: Nghe có vẻ tuyệt\! Tôi hy vọng chúng ta sẽ có chúng sớm.
...
hyperloop: no fumes (không khói thải), safe (an toàn), fast (nhanh) 

teleporter: fast, safe, eco-friendly (thân thiện với môi trường) 

**Bài 5 trang 115** 

1. Nó có hai bánh xe và một bàn đạp → bicycle   
2. Nó có bốn bánh xe. Nó chạy bằng xăng hoặc điện à có thể chở tối đa tám hành khách → car   
3. Nó chở nhiều hành khách và chạy trên đường rây → train   
4. Nó chèo trên biển. Nó cần gió để chèo → boat   
5. Nó di chuyển trong không gian. Nó thậm chí có thể đưa con người tới mặt trăng → spaceship. 

I think these means of transport will run on solar energy in 50 years. 
...
4\. hyperloop:  siêu vòng lặp

5\. skyTran: tàu cao tốc trên cao

**Bài 2 trang 116** 

ride: hyperloop, skyTran, a horse, a bike, a car. 

drive: a car 

fly: a bamboo-copter, a plane, a flying car 

sail /sê ồ/: chèo : a solar-powered ship 
